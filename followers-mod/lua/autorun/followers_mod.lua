...
if !ConVarExists("fmod_followers_speak") then	
   CreateConVar("fmod_followers_speak", '1', (FCVAR_ARCHIVE), "If 1, followers will tell you if they will follow you or stay at thier positions.", 0, 1)
end
...
if string.find( string.lower( data.SoundName ), "pain") or 
...
string.find( string.lower( data.SoundName ), "gut") then
