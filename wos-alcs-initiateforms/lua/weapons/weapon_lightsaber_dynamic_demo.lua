...
SWEP.PrintName = "Dynamic Form Demo" --Name of the lightsaber
SWEP.Class = "weapon_lightsaber_dynamic_demo" --The file name of this swep
...
SWEP.ForcePowerList = { "Force Push", "Force Pull", "Saber Throw", "Force Lightning" } 
