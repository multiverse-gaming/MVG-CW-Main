...
SWEP.PrintName = "Adept Form Demo" --Name of the lightsaber
SWEP.Class = "weapon_lightsaber_adept_demo" --The file name of this swep
...
SWEP.ForcePowerList = { "Force Repulse", "Force Pull", "Force Leap" } 
