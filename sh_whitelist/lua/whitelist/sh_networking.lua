...
if (SERVER) then
	...
	easynet.Callback("SH_WHITELIST.Notify", function(data)
		SH_WHITELIST:Notify(data.message, nil, SH_WHITELIST.Style[data.good and "success" or "failure"], IsValid(_SH_WHITELIST) and _SH_WHITELIST or nil) -- 76561198113025297
	end)
