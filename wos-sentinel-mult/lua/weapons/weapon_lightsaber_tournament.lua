...
SWEP.PrintName = "Tournament Lightsaber" --Name of the lightsaber

SWEP.Class = "weapon_lightsaber_tournament" --The file name of this swep
...
SWEP.UseHilt = "models/sgg/starwars/weapons/w_saber_1_hilt.mdl" -- Model path of the hilt
