...
SWEP.PrintName = "Tournament Lightsaber (Twin Hilt)" --Name of the lightsaber
SWEP.Class = "weapon_lightsaber_tournament_Twin" --The file name of this swep
...
SWEP.UseSecHilt = "models/starwars/cwa/lightsabers/aaylasecura.mdl" -- Model path of the hilt
SWEP.UseSecLength = 46
SWEP.UseSecWidth = 2
