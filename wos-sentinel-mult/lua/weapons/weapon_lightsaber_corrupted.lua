...
SWEP.PrintName = "Corrupted Lightsaber" --Name of the lightsaber
SWEP.Class = "weapon_lightsaber_corrupted" --The file name of this swep
...
SWEP.SaberDamage = 10 --How much damage the saber does when it's being swung
