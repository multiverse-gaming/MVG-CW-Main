...
SWEP.PrintName = "General Grievous Lightsaber" --Name of the lightsaber
...
SWEP.ForcePowerList = { "Force Leap", "Charge" } 
...
SWEP.UseColor = Color( 35, 255, 10 ) -- RGB Color of saber. Red = Color( 255, 0, 0 ) Blue = Color( 0, 0, 255 ), etc.
...
SWEP.UseSecHilt = "models/starwars/cwa/lightsabers/adigalia.mdl"
SWEP.UseSecLength = false
SWEP.UseSecWidth = false
SWEP.UseSecColor = Color( 10, 83, 255 )
