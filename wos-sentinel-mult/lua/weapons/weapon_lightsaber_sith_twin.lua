...
SWEP.PrintName = "Sith Twin Lightsaber" --Name of the lightsaber
SWEP.Class = "weapon_lightsaber_sith_twin" --The file name of this swep
...
SWEP.UseHilt = "models/swtor/arsenic/lightsabers/elegantmodifieddoublebladedsaber.mdl" -- Model path of the hilt
