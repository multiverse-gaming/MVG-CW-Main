...
SWEP.PrintName = "Asajj Ventress Lightsabers" --Name of the lightsaber
...
SWEP.ForcePowerList = { "Sith Master Leap", "Saber Throw", "Sith Force Push", "Sith Group Push", "Sith Cloak", "Shadow Strike", "Advanced Force Heal", "Force Breach" } 
