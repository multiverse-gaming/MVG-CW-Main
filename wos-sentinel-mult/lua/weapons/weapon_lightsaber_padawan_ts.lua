...
SWEP.WorldModel = "models/training/training.mdl"
...
SWEP.PrintName = "Padawan Training Lightsaber" --Name of the lightsaber
SWEP.Class = "weapon_lightsaber_padawan_ts" --The file name of this swep
...
SWEP.UseLength = 26 -- Length of the saber 
SWEP.UseWidth = 0.1 -- Width of the saber
