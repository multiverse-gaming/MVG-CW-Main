...
SWEP.PrintName = "Count Dooku Lightsaber" --Name of the lightsaber
...
SWEP.ForcePowerList = { "Sith Master Leap", "Force Choke", "Force Lightning", "Lightning Stream", "Advanced Force Heal", "Enemy Mystify", "Force Breach" }
