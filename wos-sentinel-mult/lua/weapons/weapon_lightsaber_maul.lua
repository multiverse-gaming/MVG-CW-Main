...
SWEP.PrintName = "Darth Maul Lightsaber" --Name of the lightsaber
...
SWEP.ForcePowerList = { "Sith Master Leap", "Saber Throw", "Ground Slam", "Rage", "Advanced Force Heal", "Enemy Guard", "Enemy Mystify", "Force Breach" } 
