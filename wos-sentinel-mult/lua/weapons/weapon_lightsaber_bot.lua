...
SWEP.WorldModel = "models/weapons/starwars/w_kr_hilt.mdl"
...
SWEP.PrintName = "Bot Saber" --Name of the lightsaber
SWEP.Class = "weapon_lightsaber_bot" --The file name of this swep
...
SWEP.UseHilt = "models/weapons/starwars/w_kr_hilt.mdl" -- Model path of the hilt
