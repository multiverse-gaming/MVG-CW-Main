...
SWEP.PrintName = "Sith Warrior Lightsaber" --Name of the lightsaber
SWEP.Class = "weapon_lightsaber_wos_warrior" --The file name of this swep
...
SWEP.ForcePowerList = { "Force Leap", "Force Push", "Force Pull", "Charge", "Channel Hatred", } 
