...
SWEP.ForcePowerList = { "Consular Force Leap", "Sense Weakness", "Consular Force Speed", "Force Protect", "Force Shield", "Force Group Shield", "Consular Force Heal", "Group Heal", "Group Push" } 
