...
SWEP.PrintName = "Savage Opress Lightsaber" --Name of the lightsaber
SWEP.Class = "weapon_lightsaber_opress" --The file name of this swep
...
SWEP.SaberDamage = 275 --How much damage the saber does when it's being swung
...
SWEP.ForcePowerList = { "Force Leap", "Charge", "Saber Throw", "Advanced Force Heal" } 
