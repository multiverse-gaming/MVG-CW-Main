...
SWEP.PrintName = "Pre Viszla Lightsaber" --Name of the lightsaber
SWEP.Class = "weapon_lightsaber_viszla" --The file name of this swep
...
SWEP.ForcePowerList = { "Mandalorian Fire", "Advanced Force Heal" } 
...
SWEP.UseColor = Color( 0, 0, 0 ) -- RGB Color of saber. Red = Color( 255, 0, 0 ) Blue = Color( 0, 0, 255 ), etc.
