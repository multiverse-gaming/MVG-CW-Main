...
SWEP.PrintName = "Guardian Lightsaber" --Name of the lightsaber
SWEP.Class = "weapon_lightsaber_preset_guardian" --The file name of this swep
...
SWEP.ForcePowerList = { "Guardian Leap", "Saber Throw", "Force Speed", "Force Guard", "Force Stamina", "Ground Slam", "Force Reflect Half", "Weak Hardened Force Push", "Force Valor" } 
