...
ITEM.Name = "Mythic Armor Igniter"

ITEM.Description = "Gives you a lot more armor"
...
ITEM.OnEquip = function( wep )
	if (IsValid(wep.Owner)) then
		wep.Owner:SetMaxArmor(wep.Owner:GetMaxArmor() + 50)
		wep.Owner:SetArmor(wep.Owner:Armor() + 50)
	end
end
