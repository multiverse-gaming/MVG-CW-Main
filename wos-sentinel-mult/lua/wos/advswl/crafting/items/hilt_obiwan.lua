...
ITEM.Name = "Obi-Wan Kenobi's Hilt EP1"
...
ITEM.Model = "models/sgg/starwars/weapons/w_obiwan_ep1_saber_hilt.mdl"
...
ITEM.OnEquip = function( wep )
	if (IsValid(wep) && wep.Owner) then
		...
		if (string.match(team_name, "General")) then
			wep.UseHilt = "models/sgg/starwars/weapons/w_obiwan_ep1_saber_hilt.mdl"
			wep.UseLength = 46
