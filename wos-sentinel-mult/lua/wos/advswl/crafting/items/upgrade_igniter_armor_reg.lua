...
ITEM.Name = "Regular Armor Igniter"

ITEM.Description = "Gives you little more armor"
...
ITEM.OnEquip = function( wep )
	if (IsValid(wep.Owner)) then
		wep.Owner:SetMaxArmor(wep.Owner:GetMaxArmor() + 15)
		wep.Owner:SetArmor(wep.Owner:Armor() + 15)
	end
end
