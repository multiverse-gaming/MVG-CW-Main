...
ITEM.Name = "Purified Crystal ( Yellow )"

--The description that appears with the item name
ITEM.Description = "Corrupted and repaired, it has grown stronger under pressure"
...
ITEM.OnEquip = function( wep )
	wep.CustomSettings[ "Blade" ] = "SWTOR 10"
	wep.UseColor = Color( 255, 255, 0, 255 )
	wep.MaxForce = wep.MaxForce + 30
end
