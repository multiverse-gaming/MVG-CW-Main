...
ITEM.Name = "Mythic Blind Idler"

ITEM.Description = "Allows you to blind cheaper, much more."
...
ITEM.OnEquip = function( wep )
	if (IsValid(wep.Owner)) then
		wep.BlindIdleCost = true
		wep.BlindIdleEffect = true
		wep.BlindIdleDoubleEffect = true
	end
end
