...
ITEM.Name = "Mythic Reflect Idler"

ITEM.Description = "Allows you to reflect cheaper, much more."
...
ITEM.OnEquip = function( wep )
	if (IsValid(wep.Owner)) then
		wep.ReflectIdleCost = true
		wep.ReflectIdleEffect = true
		wep.ReflectIdleDoubleEffect = true
	end
end
