...
TREE.Name = "Sentinel Outer Skills"

--Description of the skill tree
TREE.Description = "Skills from the Sentinel and Consular paths are harder for you to learn, and worse than usual. Hopefully you can keep up."
...
TREE.JobRestricted = { "TEAM_JEDISENTINEL", "TEAM_501STJEDI", "TEAM_212THJEDI", "TEAM_327THJEDI", "TEAM_WPJEDI", "TEAM_GMJEDI", "TEAM_CGJEDI" }
...
TREE.Tier[1][1] = {
	...
	Description = "Extremely inefficient, but over time, this will get you back on your feet.",
...
TREE.Tier[1][2] = {
	...
	Description = "Charge towards your enemy - costs more force and a higher cooldown. Good luck.",
