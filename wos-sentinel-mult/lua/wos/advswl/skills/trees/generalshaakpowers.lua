...
TREE.Name = "Shaak Ti Skill Tree"

--Description of the skill tree
TREE.Description = "Shaak Ti's special skills."
...
TREE.JobRestricted = { "TEAM_JEDIGENERALSHAAK", "TEAM_CGGENERALSHAAK" }
...
TREE.Tier[1][2] = {
	...
	OnPlayerSpawn = function( ply ) end,
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) wep:AddForm( "Shaak", 1 ) wep:AddForm( "Shaak", 2 ) end,
}
