...
TREE.Name = "Mundi Skill Tree"

--Description of the skill tree
TREE.Description = "Ki Adi Mundi's special skills."
...
TREE.JobRestricted = { "TEAM_JEDIGENERALADI", "TEAM_GMGENERALADI" }
...
TREE.Tier[1][1] = {
	...
	Description = "Old reliable - with no downsides.",
...
TREE.Tier[1][2] = {
	...
	OnPlayerSpawn = function( ply ) end,
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) wep:AddForm( "Mundi", 1 ) end,
}

TREE.Tier[1][3] = {
	Name = "Stamina Increase",
	Description = "Mundi is adept at deflecting.",
	Icon = "wos/forceicons/absorb.png",
	PointsRequired = 1,
	Requirements = {},
	OnPlayerSpawn = function( ply ) end,
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) wep:SetMaxStamina(wep:GetMaxStamina() + 20)  end,
}
