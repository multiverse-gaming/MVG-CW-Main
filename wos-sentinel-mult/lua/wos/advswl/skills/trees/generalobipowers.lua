...
TREE.Name = "Obi Wan Skill Tree"

--Description of the skill tree
TREE.Description = "Obi Wan's special skills."
...
TREE.JobRestricted = { "TEAM_JEDIGENERALOBI", "TEAM_212THGENERALOBI" }
...
TREE.Tier[1][2] = {
	...
	OnPlayerSpawn = function( ply ) end,
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) wep:AddForm( "Obi", 1 ) wep:AddForm( "Obi", 2 ) end,
}

TREE.Tier[1][3] = {
	Name = "Stamina Increase",
	Description = "Obi Wan is a master of deflection.",
	Icon = "wos/forceicons/absorb.png",
	PointsRequired = 1,
	Requirements = {},
	OnPlayerSpawn = function( ply ) end,
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) wep:SetStamina( wep:GetMaxStamina() + 50 ) end,
}
