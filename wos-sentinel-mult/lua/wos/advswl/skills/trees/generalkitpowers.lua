...
TREE.Name = "Kit Fisto Skill Tree"

--Description of the skill tree
TREE.Description = "Kit Fisto's special skills."
...
TREE.JobRestricted = { "TEAM_JEDIGENERALKIT", "TEAM_RCGENERALKIT" }
...
TREE.Tier[1][1] = {
	Name = "Force Barrier",
	Description = "Places an impassible barrier in front of you.",
...
TREE.Tier[1][2] = {
	...
	OnPlayerSpawn = function( ply ) end,
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) wep:AddForm( "Fisto", 1 ) end,
}

TREE.Tier[1][3] = {
	Name = "Health Increase",
	Description = "Kit Fisto is pretty hardy.",
