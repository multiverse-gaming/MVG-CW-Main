...
TREE.Name = "Consular Outer Skills"

--Description of the skill tree
TREE.Description = "Skills from the Sentinel and Guardian paths are harder for you to learn, and worse than usual. Hopefully you can keep up."
...
TREE.JobRestricted = { "TEAM_JEDICONSULAR", "TEAM_501STJEDI", "TEAM_212THJEDI", "TEAM_327THJEDI", "TEAM_WPJEDI", "TEAM_GMJEDI", "TEAM_CGJEDI"}
...
TREE.Tier[1][2] = {
	Name = "Guardian - Hardened Force Push",
	Description = "Throw your enemy, but hurt yourself in the process. It also can never land the killing blow on an opponent.",
