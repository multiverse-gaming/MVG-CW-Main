...
TREE.Name = "Plo Koon Skill Tree"

--Description of the skill tree
TREE.Description = "Plo's special skills."
...
TREE.JobRestricted = { "TEAM_JEDIGENERALPLO", "TEAM_WPGENERALPLO" }
...
TREE.Tier[1][1] = {
	...
	Description = "Judge those worthy of it.",
...
TREE.Tier[1][2] = {
	...
	OnPlayerSpawn = function( ply ) end,
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) wep:AddForm( "Plo", 1 ) wep:AddForm( "Plo", 2 ) end,
}

TREE.Tier[1][3] = {
	Name = "Force Upgrade",
	Description = "Plo Koon has an excelent understanding of the force.",
