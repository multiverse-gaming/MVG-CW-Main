...
TREE.Name = "Ahsoka Skill Tree"

--Description of the skill tree
TREE.Description = "Ahsoka Tano's special skills."
...
TREE.JobRestricted = { "TEAM_JEDIGENERALTANO", "TEAM_501STGENERALTANO" }
...
TREE.Tier[1][1] = {
	Name = "Force Reflect",
	Description = "Reflects all damage back, briefly.",
...
TREE.Tier[1][3] = {
	...
	Description = "Ahsoka is known for being cool under fire.",
	Icon = "wos/forceicons/absorb.png",
	PointsRequired = 1,
	Requirements = {},
	OnPlayerSpawn = function( ply ) end,
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) wep:SetStamina( wep:GetMaxStamina() + 30 ) end,
}
