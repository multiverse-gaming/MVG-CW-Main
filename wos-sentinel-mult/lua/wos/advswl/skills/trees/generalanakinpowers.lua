...
TREE.Name = "Anakin Skill Tree"

--Description of the skill tree
TREE.Description = "Anakin Skywalkers's special skills."
...
TREE.JobRestricted = { "TEAM_JEDIGENERALSKYWALKER", "TEAM_501STGENERALSKYWALKER" }
...
TREE.Tier[1][1] = {
	Name = "Force Choke",
	Description = "Unleash your coiled rage.",
...
TREE.Tier[1][2] = {
	...
	OnPlayerSpawn = function( ply ) end,
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) wep:AddForm( "Skywalker", 1 ) wep:AddForm( "Skywalker", 2 ) end,
}

TREE.Tier[1][3] = {
	Name = "Force Increase",
	Description = "Anakin is naturally skilled in the force.",
