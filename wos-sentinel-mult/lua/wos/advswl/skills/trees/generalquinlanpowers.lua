...
TREE.Name = "Quinlan Skill Tree"

--Description of the skill tree
TREE.Description = "Quinlan Vos' special skills."
...
TREE.JobRestricted = { "TEAM_JEDIGENERALVOS", "TEAM_SHADOWGENERALVOS" }
...
TREE.Tier[1][1] = {
	Name = "Advanced Cloak",
	Description = "Meld into the darkness.",
...
TREE.Tier[1][2] = {
	...
	OnPlayerDeath = function( ply ) end,
	OnSaberDeploy = function( wep ) wep:AddForm( "Vos", 1 ) end,
}

TREE.Tier[1][3] = {
	Name = "Speed Upgrade",
	Description = "Quinlan needs to be quick to keep up with the shadows.",
