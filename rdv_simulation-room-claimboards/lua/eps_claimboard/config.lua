...
EPS_ClaimBoard_Config.Battalions = {
    ...
    ["327th Engineering Corps"] = { -- Otherwise if you want certain teams to have certain battalions put the jobs name here.
        Jobs = {
            ["327th General"] = true,
            ["327th Marshal Commander"] = true,
            ["327th Commander"] = true,
            ["327th Executive Officer"] = true,
            ["327th Major"] = true,
            ["327th Lieutenant"] = true,
            ["327th ARC"] = true,
            ["327th Alpha ARC"] = true,
            ["327th Storm Squadron"] = true,
            ["327th K Company"] = true,
            ["327th Carnivore Company"] = true,
            ["Engineering Officer"] = true,
            ["327th Medic Officer"] = true,
            ["327th Medic Trooper"] = true,
        },
    },
    ...
    ["Fleet Officers"] = { -- Otherwise if you want certain teams to have certain battalions put the jobs name here.
        Jobs = {
            ["Grand Admiral"] = true,
            ["Fleet Admiral"] = true,
            ["Fleet High Ranking"] = true,
            ["Fleet Member"] = true,
            ["Fleet Recruit"] = true,
            ["Fleet Maverick"] = true,
            ["Fleet StarFighter Officer"] = true,
            ["Fleet Chief of Intelligence"] = true,
            ["Fleet Intelligence Officer"] = true,
            ["Fleet Director of Research and Development"] = true,
            ["Fleet Research and Development Officer"] = true,
            ["Clone Advisor"] = true,
            ["NSO Advisor"] = true,
        },
    },
