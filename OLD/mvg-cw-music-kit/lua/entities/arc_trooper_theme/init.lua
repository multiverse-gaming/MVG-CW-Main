...
local ent = ents.Create( "arc_trooper_theme" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
self.Entity:EmitSound("mvg_music/arc_trooper_theme.mp3",600)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "ARC Trooper Theme activated")
end
...
self.Entity:StopSound("mvg_music/arc_trooper_theme.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "ARC Trooper Theme deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "ARC Trooper Theme removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
