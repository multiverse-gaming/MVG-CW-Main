...
local ent = ents.Create( "geonosis_battle" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
self.Entity:EmitSound("mvg_music/geonosis_battle.mp3",600)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Geonosis Battle activated")
end
...
self.Entity:StopSound("mvg_music/geonosis_battle.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Geonosis Battle deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Geonosis Battle removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
