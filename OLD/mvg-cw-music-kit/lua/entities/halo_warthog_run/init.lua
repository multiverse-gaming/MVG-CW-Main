...
function ENT:Initialize()
	...
	self.Entity:SetNetworkedString( 52, "" .. sirensquadnames[sirensquadnumber] .. "" )
...
local ent = ents.Create( "halo_warthog_run" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
self.Entity:EmitSound("Oogway/halo_warthog_run.mp3",600)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Halo Warthog Run activated")
end
...
self.Entity:StopSound("Oogway/halo_warthog_run.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Halo Warthog Run deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Halo Warthog Run removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
