...
local ent = ents.Create( "trailer_music_extended" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
self.Entity:EmitSound("Oogway/trailer_music_extended.mp3",600)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Trailer Music Extended activated")
end
...
self.Entity:StopSound("Oogway/trailer_music_extended.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Trailer Music Extended deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Trailer Music Extended removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
