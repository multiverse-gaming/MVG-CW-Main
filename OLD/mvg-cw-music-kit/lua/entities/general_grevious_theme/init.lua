...
local ent = ents.Create( "general_grevious_theme" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
self.Entity:EmitSound("Oogway/general_grevious_theme.mp3",600)
...
self.Entity:StopSound("Oogway/general_grevious_theme.mp3")
