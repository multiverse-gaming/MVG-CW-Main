...
local ent = ents.Create( "across_the_stars" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
self.Entity:EmitSound("Oogway/across_the_stars.mp3",600)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Across the Stars activated")
end
...
self.Entity:StopSound("Oogway/across_the_stars.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Across the Stars deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Across the Stars removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
