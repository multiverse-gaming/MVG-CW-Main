...
local ent = ents.Create( "sweet_caroline" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
self.Entity:EmitSound("mvg_music/sweet_caroline.mp3",600)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "OSweet Caroline activated")
end
...
self.Entity:StopSound("mvg_music/sweet_caroline.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Sweet Caroline deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Sweet Caroline removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
