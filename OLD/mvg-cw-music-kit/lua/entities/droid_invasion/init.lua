...
local ent = ents.Create( "droid_invasion" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
self.Entity:EmitSound("mvg_music/droid_invasion.mp3",600)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Droid Invasion activated")
end
...
self.Entity:StopSound("mvg_music/droid_invasion.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Droid Invasion deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Droid Invasion removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
