...
local ent = ents.Create( "order_66_sad" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
self.Entity:EmitSound("mvg_music/order_66_sad.mp3",600)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Order 66 Theme Sad activated")
end
...
self.Entity:StopSound("mvg_music/order_66_sad.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Order 66 Theme Sad deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Order 66 Theme Sad removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
