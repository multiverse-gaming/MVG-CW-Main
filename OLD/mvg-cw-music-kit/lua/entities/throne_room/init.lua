...
local ent = ents.Create( "throne_room" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
self.Entity:EmitSound("Oogway/throne_room.mp3",600)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Throne Room activated")
end
...
self.Entity:StopSound("Oogway/throne_room.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Throne Room deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Throne Room removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
