...
local ent = ents.Create( "emperor_theme" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
self.Entity:EmitSound("Oogway/emperor_theme.mp3",600)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Emperor Theme activated")
end
...
self.Entity:StopSound("Oogway/emperor_theme.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Emperor Theme deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Emperor Theme removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
