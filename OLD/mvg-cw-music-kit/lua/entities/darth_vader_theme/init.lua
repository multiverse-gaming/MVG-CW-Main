...
function ENT:Initialize()
	...
	self.Entity:SetNetworkedString( 12, "" .. sirensquadnames[sirensquadnumber] .. "" )
...
local ent = ents.Create( "Darth_Vader_Theme" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
self.Entity:EmitSound("Oogway/darth_vader_theme.mp3",600)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Darth Vader Theme activated")
end
...
self.Entity:StopSound("Oogway/darth_vader_theme.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Darth Vader Theme deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Darth Vader Theme removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
