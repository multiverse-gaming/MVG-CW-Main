...
local ent = ents.Create( "clones_theme_twosteps" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
self.Entity:EmitSound("mvg_music/clones_theme_twosteps.mp3",600)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Clone Troopers Theme activated")
end
...
self.Entity:StopSound("mvg_music/clones_theme_twosteps.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Clone Troopers Theme deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Clone Troopers Theme removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
