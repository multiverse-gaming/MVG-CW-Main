...
local ent = ents.Create( "Clone_Theme" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
self.Entity:EmitSound("Oogway/Clone_Theme.mp3",600)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Clone Theme activated")
end
...
self.Entity:StopSound("Oogway/Clone_Theme.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Clone Theme deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Clone Theme removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
