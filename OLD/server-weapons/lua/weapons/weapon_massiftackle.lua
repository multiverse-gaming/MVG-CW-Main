...
SWEP.Primary.AmmoConsumption = 100
//SWEP.Primary.StatusEffect = "stun"
//SWEP.Primary.StatusEffectDmg = 20
//SWEP.Primary.StatusEffectDur = 10
...
function SWEP:DealDamage()
	...
	if ( SERVER && IsValid( tr.Entity ) && ( tr.Entity:IsNPC() || tr.Entity:IsPlayer() || tr.Entity:Health() > 0 ) ) then
		...
		//	dmginfo:SetDamage( math.random( 80, 90 ) )
		end
		...
		GMSNX:AddStatus(tr.Entity, self.Owner, "stun", 3, 20, false) --GMSNX:AddStatus( target, dealer, type, a, b, particles)
