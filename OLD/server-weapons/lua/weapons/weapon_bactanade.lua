...
SWEP.Primary.Round			=("bacta_granade")
SWEP.Primary.Range 					= 950
SWEP.Velocity				=950
SWEP.Velocity_Underhand		=400
SWEP.Delay					=0.23

SWEP.RPMGrenadeBase	=  1
...
SWEP.VElements={
	["n"]={type="Model",model="models/riddickstuff/bactagrenade/bactanade.mdl",bone="Weapon_F1",rel="",pos=Vector(-0.7,0.2,01.1),angle=Angle(0,105,0),size=Vector(0.7,0.7,0.7),color=Color(255,255,255,255),surpresslightning=false,material="",skin=0,bodygroup={}},
}

SWEP.WElements={
	["n"]={type="Model",model="models/riddickstuff/bactagrenade/bactanade.mdl",bone="ValveBiped.Bip01_R_Hand",rel="",pos=Vector(03,02,0),angle=Angle(0,180,180),size=Vector(0.9,0.9,0.9),color=Color(255,255,255,255),surpresslightning=false,material="",skin=0,bodygroup={}}
}
