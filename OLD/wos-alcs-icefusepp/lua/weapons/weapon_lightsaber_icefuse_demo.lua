...
SWEP.PrintName = "Icefuse Demo Saber" --Name of the lightsaber
SWEP.Class = "weapon_lightsaber_icefuse_demo" --The file name of this swep
...
SWEP.ForcePowerList = {"Saber Barrier", "Force Choke", "Force Blind", "Adrenaline", "Force Slow", "Force Stasis", "Group Pull", "Group Push", "Group Lightning", "Electric Judgement", "Force Whirlwind", "Force Breach", "Teleport", "Destruction", "Group Choke"}
