...
SWEP.WorldModel = "models/donation2/donation2.mdl"
...
SWEP.PrintName = "Tournament Lightsaber (Staff)" --Name of the lightsaber

SWEP.Class = "weapon_lightsaber_tournament_staff" --The file name of this swep
...
SWEP.ForcePowerList = {"Force Leap", "Meditate"} 
...
SWEP.UseHilt = "models/donation2/donation2.mdl" -- Model path of the hilt
...
SWEP.UseSwingSound = "lightsaber/saber_swing1.wav" -- The swing sound path
