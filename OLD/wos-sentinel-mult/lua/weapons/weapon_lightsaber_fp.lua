...
SWEP.PrintName = "First Person Lightsaber" --Name of the lightsaber
SWEP.Class = "weapon_lightsaber_fp" --The file name of this swep
...
SWEP.FirstPerson = true

SWEP.DevestatorList = { "Kyber Slam" }

SWEP.ForcePowerList = { "Force Leap", "Force Absorb", "Force Heal", "Group Heal", "Cloak", "Advanced Cloak", "Charge", "Force Lightning", "Shadow Strike", "Saber Throw", "Force Repulse", "Force Push", "Force Pull", "Slash" } 
