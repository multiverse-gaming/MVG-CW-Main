...
if CLIENT then
language.Add("tool.npc_spawnplatform.weapondamagemultiplier","Damage Multiplier")
language.Add("tool.npc_spawnplatform.weapondamagemultiplier.help","0 = 0%, 1 = 100%, these are related to TFA actual stats (Wont change now if they change)")
end
...
function TOOL.BuildCPanel(CPanel)
	...
	do -- NPC Selector
		...
		AddControl(CPanel, "Slider", "weapondamagemultiplier", {
