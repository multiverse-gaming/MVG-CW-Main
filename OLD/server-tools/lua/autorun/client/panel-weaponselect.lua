...
function PANEL:Init()
	...
	for _, tab in pairs(list.Get("NPCUsableWeapons")) do
		...
		if tab.class == "rw_swnpc_random_cis" or "rw_swnpc_random_rep" or "rw_swnpc_dc15s" or "rw_swnpc_dc15a" or "rw_swnpc_dc17" or "rw_swnpc_dp23" or "rw_swnpc_valkenx38" or "rw_swnpc_e5" or "rw_swnpc_e5c" or "rw_swnpc_e5s" or "rw_swnpc_se14" or "rw_swnpc_sg6" then
