...
function ENT:Initialize()
	...
	self:SetModel("models/turret/lbmodels/cannongg_turret.mdl")
...
function ENT:PhysicsSimulate( phys, deltatime )
	...
	self.ShadowParams.pos = self.BasePos + self.turretBase:GetUp()*10
