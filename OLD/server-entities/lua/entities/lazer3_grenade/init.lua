...
ENT.turretBaseModel="models/turret/lbmodels/cannong_stand.mdl"
...
function ENT:Initialize()
	...
	self:SetModel("models/turret/lbmodels/cannonggg_turret.mdl")
	...
	self.ShotSound=Sound("nade_turret")
...
function ENT:PhysicsSimulate( phys, deltatime )
	...
	self.ShadowParams.pos = self.BasePos + self.turretBase:GetUp()*-1
