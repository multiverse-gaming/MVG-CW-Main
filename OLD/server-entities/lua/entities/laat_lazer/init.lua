...
function ENT:Initialize()
	...
	Tracer:SetKeyValue("lifetime","20")
	...
	Tracer:SetKeyValue("rendercolor","0 255 0")
...
function ENT:Think()
	...
	if tr.Hit then
		...
		util.BlastDamage(self.Entity, self.Entity, tr.HitPos, 500, 200)
		local effectdata = EffectData()
		...
		util.ScreenShake(tr.HitPos, 10, 5, 1, 600 )
