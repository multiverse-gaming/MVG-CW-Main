...
function DrawTheDatapadMenu()
		...
		frame:SetPos( 50, 50 )	
		frame:MakePopup()
		frame:SetTitle("Bombs Defense")														-- Title
		frame.Paint = function(self, w, h)
			draw.RoundedBox(0,0,0,w, h, Color(0,0,0,255))
			draw.RoundedBox( 0, 2, 2, w-4, h-4, Color(  25,  25, 112, 255 ))
		end
		local TextEntry = vgui.Create( "DTextEntry", frame )									-- Create text field
		TextEntry:SetPos( 25, 50 )
		TextEntry:SetSize( 450 , 125 )
		TextEntry:SetText("This area is only intended for the BSQ. The various bombs and the possible situations when you want to defuse a bomb are listed here.")			
		TextEntry:SetMultiline(true)
		local DermaListView = vgui.Create("DListView")											-- Show player list
		DermaListView:SetParent(frame)
		DermaListView:SetPos(25, 200)
		DermaListView:SetSize(450, 110)
		DermaListView:SetMultiSelect(false)
		DermaListView:AddColumn("Situation")													-- Column with situations
		DermaListView:AddColumn("Kabel")														-- Column with cable to click
