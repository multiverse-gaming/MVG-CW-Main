...
ENT.PrintName = "Trade Federation Bomber"
ENT.Author = "Salty"
...
ENT.MDL = "models/salty/TradeFedBomber.mdl"
...
function ENT:InitWeapons()
	self.FirePositions = {
		Vector(180.98,-109.41,57.31),
		Vector(179.49,109.37,57.46),
	}
	...
	weapon.Attack = function( ent )
		...
		ent._nextMissle = T + 0.50

		ent._swapMissile = not ent._swapMissile

		local Pos = Vector(203.49,-0.51,52.76 )
