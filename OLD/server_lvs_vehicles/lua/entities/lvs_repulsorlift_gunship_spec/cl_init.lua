...
function ENT:BTRProjector()
	...
	if Fire then
		...
		util.Effect( "lvs_laat_right_projector_spec", effectdata )
	end
end
...
function ENT:BTLProjector()
	...
	if Fire then
		local effectdata = EffectData()
		effectdata:SetEntity( self )
		util.Effect( "lvs_laat_left_projector_spec", effectdata )
	end
end
...
function ENT:WingTurretProjector()
	...
	if FireWingTurret then
		local effectdata = EffectData()
		effectdata:SetEntity( self )
		util.Effect( "lvs_laat_wing_projector_spec", effectdata )
	end
end
