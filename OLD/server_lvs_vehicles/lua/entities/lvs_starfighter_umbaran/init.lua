...
function ENT:OnSpawn( PObj )
	...
	self:AddDriverSeat( Vector(158.89,0,194.267), Angle(0,-90,0) ).HidePlayer = true

	self:AddEngine( Vector(-35.567,0,204.056) )
	self:AddEngineSound( Vector(-35.567,0,204.056) )
