...
function ENT:OnSpawn( PObj )
	...
	local s = ents.Create("prop_dynamic")
	s:SetModel("models/barc/stretcher.mdl")
	...
	local Pod = self:AddPassengerSeat( Vector(-33,-40,17), Angle(0,90,90) )
	Pod:SetVehicleClass("wounded") 

    	local DriverSeat = self:AddDriverSeat( Vector(-27,0,15), Angle(0,-90,5) )
	DriverSeat:SetVehicleClass("phx_seat3")
