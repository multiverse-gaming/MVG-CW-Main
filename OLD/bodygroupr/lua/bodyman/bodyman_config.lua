BODYMAN.HelpText = [[Select Bodygroups in the right-hand panel.
...
BODYMAN.ClosetName = "Armoury" -- what should the closet be called?
BODYMAN.ClosetHelpText = [[Press [E] to customize your
appearance.]]
