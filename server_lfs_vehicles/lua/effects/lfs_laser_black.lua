...
EFFECT.Mat = Material( "effects/blueblackflash" )
...
function EFFECT:Init( data )
	...
	for i = 0, 12 do
		...
		local particle = emitter:Add( "effects/muzzleflashx_nemole_w", Pos )
		local Size = 2
...
function EFFECT:Render()
	...
	fDelta = math.Clamp( fDelta, 0, 1 ) ^ 3 -- lasers are faster than bullets...
