...
function EFFECT:doFX( pos )
	...
	if self.Emitter then
		...
		self.TurnOnTime = self.TurnOnTime or 0
		if self.TurnOnTime < CurTime() then
			...
			if particle then
				particle:SetVelocity( -self.Entity:GetForward() * math.Rand(150,300) + self.Entity:GetVelocity())
...
function EFFECT:Render()
	...
	render.DrawSprite( pos, 130, 130, Color( r, g, b, 255 ) )
end
