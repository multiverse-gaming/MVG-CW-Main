	...
	Levels = {
...

		{
			...
			Teams = {
				...
				TEAM_JEDICONSULAR, TEAM_JEDIGUARDIAN, TEAM_JEDISENTINEL,
				TEAM_DUA, TEAM_SIEGE, TEAM_MEDMM, TEAM_JAGUAR,
				TEAM_RCGRINDER, TEAM_RCGRIP, TEAM_RCKURZ, TEAM_RCWATSON, TEAM_CDCPT,TEAM_CDOFF,TEAM_GAURDL,TEAM_GAURDTRP,TEAM_CDSGT,TEAM_CDTRP,TEAM_MAND,TEAM_SDWLEAD,TEAM_SDWMEM,TEAM_MARLEAD,TEAM_MARTRP,TEAM_JEDICONGUARD,TEAM_JEDISENGUARD,TEAM_JEDIGUARGUARD,TEAM_DUA, TEAM_SIEGE, TEAM_MEDMM, TEAM_JAGUAR}
		},

		{
			Name  = "Level 3",
			Color = Color(0, 255, 0),
			Teams = { TEAM_CTSDSGT, TEAM_ASSISTANTMEDICALDIRECTOR,TEAM_WALONVAU,TEAM_KALSKIRATA,TEAM_FENRAU, TEAM_MEDICALDIRECTOR, TEAM_501STCOMMANDER, TEAM_501STEXECUTIVEOFFICER, TEAM_501STMAJOR, TEAM_212THCOMMANDER, TEAM_212THEXECUTIVEOFFICER, TEAM_212THMAJOR, TEAM_GREENCOMMANDER, TEAM_GREENEXECUTIVEOFFICER, TEAM_GREENMAJOR, TEAM_CGCOMMANDER, TEAM_CGEXECUTIVEOFFICER, TEAM_CGMJR, TEAM_GMCOMMANDER, TEAM_GMEXECUTIVEOFFICER, TEAM_GMMAJOR, TEAM_ARCCOMMANDER, TEAM_ARCEXECUTIVEOFFICER, TEAM_ARCMAJOR, TEAM_CECOMMANDER, TEAM_CEEXECUTIVEOFFICER, TEAM_CECHIEF, TEAM_ARCCOLT, TEAM_ARCHAVOC, TEAM_RCBOSS, TEAM_RCFIXER, TEAM_RCSEV, TEAM_RCSCORCH, TEAM_CRCHIEFTAIN, TEAM_CRUNDERCHIEF, TEAM_CREXECUTOR, TEAM_JEDICOUNCIL, TEAM_SENATE, TEAM_SENATECPT, TEAM_SHADOWMJR, TEAM_SHADOWEXO, TEAM_SHADOWCO, TEAM_NSOCPT, TEAM_NSOA, TEAM_NSOMED, TEAM_NSOCQC,TEAM_JEDIGURDCHIEF}
		},

		{
			Name  = "Level 4",
			Color = Color(200, 0, 255),
			Teams = {TEAM_FLEETCTI, TEAM_MEDICALGENERAL,TEAM_CDGENERAL, TEAM_RCADVISOR,TEAM_MCOVAU, TEAM_501STGENERAL, TEAM_212THGENERAL, TEAM_GREENGENERAL, TEAM_CGGENERAL, TEAM_GMGENERAL, TEAM_ARCGENERAL, TEAM_CEGENERAL, TEAM_RCGENERAL, TEAM_SHADOWGENERAL, TEAM_WPGENERAL, TEAM_501STMCOMMANDER, TEAM_212THMCOMMANDER, TEAM_GREENMCOMMANDER, TEAM_CGMCOMMANDER, TEAM_GMMCOMMANDER, TEAM_ARCMCOMMANDER, TEAM_CEMCOMMANDER, TEAM_ARCMC, TEAM_RCMCO, TEAM_ARCHHARBINGER, TEAM_MEDICALMCO, TEAM_FLEETHSO, TEAM_FLEETEO, TEAM_FLEETMO, TEAM_FLEETRECRUIT, TEAM_FLEETENSIGN, TEAM_FLEETOFFICER, TEAM_FLEETPILOT, TEAM_FLEETLT, TEAM_FLEETLTCMDR, TEAM_FLEETCMDR, TEAM_FLEETCPT, TEAM_FLEETCOM, TEAM_FLEETADMIRAL, TEAM_FLEETMEMBERSNR, TEAM_FLEETMEMBER, TEAM_GRANDADMIRAL, TEAM_SUPREMEGENERAL, TEAM_BATTALIONGENERAL, TEAM_ASSISTANTBATTALIONGENERAL, TEAM_JEDIGRANDMASTER, TEAM_JEDIGENERALSKYWALKER, TEAM_JEDIGENERALOBI, TEAM_JEDIGENERALWINDU, TEAM_JEDIGENERALTANO, TEAM_JEDIGENERALPLO, TEAM_JEDIGENERALKIT, TEAM_JEDIGENERALAAYLA, TEAM_JEDIGENERALSHAAK, TEAM_JEDIGENERALADI, TEAM_JEDIGENERALVOS, TEAM_JEDIGENERALLUMINARA, TEAM_ARCOFFICER, TEAM_GMOFFICER, TEAM_GREENOFFICER, TEAM_SHADOWOFFICER, TEAM_212THOFFICER, TEAM_501STOFFICER, TEAM_CROFFICER, TEAM_SENATEADV, TEAM_SHADOWMCO, TEAM_FLEET_MAVERICK, TEAM_FLEET_COI, TEAM_FLEET_DRD, TEAM_FLEET_IO, TEAM_FLEET_RD, TEAM_FLEET_SFOFC }
		},

		{
			Name  = "Level 5",
			Color = Color(169, 169, 169),
			Teams = { TEAM_FLEETADMIRAL, TEAM_GRANDADMIRAL, TEAM_SUPREMEGENERAL, TEAM_JEDIGRANDMASTER, TEAM_SOD, TEAM_EH, TEAM_REPUBLICCHARACTER}
		},
