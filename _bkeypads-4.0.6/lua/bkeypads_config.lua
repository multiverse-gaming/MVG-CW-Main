...
Keycards = {
	...
	SpawnWithoutKeycard = { TEAM_CLASS_D, TEAM_HOBO, TEAM_CADET, TEAM_GARSAXON, TEAM_BOSK, TEAM_HONDO, TEAM_CADBANE, TEAM_PREVISZLA, TEAM_SAVAGEOPRESS, TEAM_GENERALGRIEVOUS, TEAM_DARTHMAUL, TEAM_ASAJJVENTRESS, TEAM_COUNTDOOKU, TEAM_CUSTOMENEMY, TEAM_BXASSAULT, TEAM_BXHEAVY, TEAM_BXMARK, TEAM_BXMELEE, TEAM_BXCAPTAIN, TEAM_DEATHWATCH, TEAM_SITH, TEAM_MAGNA, TEAM_DROIDEKA, TEAM_B2DROID, TEAM_DROIDCOMMANDER, TEAM_COMMANDODROID, TEAM_B1SNIPER, TEAM_B1PILOT, TEAM_B1HEAVY, TEAM_B1BATTLE, TEAM_B1ENGINEER, TEAM_UNDEAD, TEAM_PRISONER, TEAM_PIRATETROOPER, TEAM_PIRATEHEAVY, TEAM_PIRATESNIPER, TEAM_PIRATESPECIALIST, TEAM_PIRATEMELEE, TEAM_PIRATEMEDIC, TEAM_PIRATEENGINEER, TEAM_UMBARANTROOPER, TEAM_UMBARANHEAVYTROOPER, TEAM_UMBARANSNIPER, TEAM_UMBARANENGINEER, TEAM_UMBARANOFFICER, TEAM_DURGE},
	...
	Levels = {
...

		{
			...
			Color = Color(0, 0, 255),
			Teams = {
				TEAM_CTJDSGT, TEAM_CTDSGT, TEAM_CTMDSGT,
				TEAM_212THMEDTROOPER,TEAM_GMMEDTROOPER, TEAM_GREENMEDTROOPER, TEAM_501STMEDTROOPER, TEAM_CEMEDTROOPER, TEAM_ARCMEDTROOPER, TEAM_CGMEDTROOPER,
				TEAM_501STMEDOFFICER, TEAM_212THMEDOFFICER, TEAM_GREENMEDOFFICER, TEAM_CGMEDOFFICER, TEAM_GMMEDOFFICER, TEAM_ARCMEDOFFICER, TEAM_CEMEDOFFICER,
				TEAM_RCVALE, TEAM_RCPLANK, TEAM_RCRIGGS, TEAM_RCWITT,
				TEAM_501STSERGEANT, TEAM_501STLIEUTENANT, TEAM_501STJUGGERNAUT,
				TEAM_212THLIEUTENANT, TEAM_212THHEAVYTROOPER,  TEAM_212THSERGEANT,
				TEAM_GREENMARKSMAN, TEAM_GREENRANGER, TEAM_GREENLIEUTENANT, TEAM_GREENSERGEANT,
				TEAM_CGLIEUTENANT, TEAM_CGHANDLER,  TEAM_CGSERGEANT, TEAM_CGRIOT,
				TEAM_GMMAJOR, TEAM_GMFLAMETROOPER, TEAM_GMKUTROOPER, TEAM_GMLIEUTENANT, TEAM_GMSERGEANT,
				TEAM_ARCPATHFINDER, TEAM_ARCLIEUTENANT,  TEAM_ARCSERGEANT,
				TEAM_CELIEUTENANT, TEAM_CEMECHANIC, TEAM_CEFAB,  TEAM_CESPECIALIST,
				TEAM_501STARC, TEAM_212THARC, TEAM_GMARC, TEAM_WPARC, TEAM_CEARC, TEAM_CGARC, TEAM_GCARC, TEAM_TRAINEEARC,
				TEAM_ARCALPHA501st, TEAM_ARCALPHA212th, TEAM_ARCALPHAGC, TEAM_ARCALPHACG, TEAM_ARCALPHAGM, TEAM_ARCALPHAWP, TEAM_ARCALPHACE,
				TEAM_RCHUNTER, TEAM_RCCROSSHAIR, TEAM_RCWRECKER, TEAM_RCTECH, TEAM_RCECHO,
				TEAM_RCNINER, TEAM_RCDARMAN, TEAM_RCFI, TEAM_RCATIN, TEAM_RCHOPE, TEAM_RCAIWHA, TEAM_RCAQUILA, TEAM_RCION, TEAM_RCYAYAX, TEAM_RCCORR,
				TEAM_REPUBLICCOMMANDOSGT, TEAM_REPUBLICCOMMANDOLT,
				TEAM_CRCHAMPION, TEAM_CRMASTERSTALKER, TEAM_CRMASTERWARR, TEAM_CRSTALKER, TEAM_CRWARRIOR, TEAM_CRINITIATE,
				TEAM_JEDICONSULAR, TEAM_JEDIGUARDIAN, TEAM_JEDISENTINEL, TEAM_TGJEDI,
				TEAM_212THJEDI, TEAM_327THJEDI, TEAM_501STJEDI, TEAM_GMJEDI, TEAM_WPJEDI, TEAM_CGJEDI,
				TEAM_DUA, TEAM_SIEGE, TEAM_MEDMM, TEAM_JAGUAR,
				TEAM_RCGRINDER, TEAM_RCGRIP, TEAM_RCKURZ, TEAM_RCWATSON, TEAM_GAURDL,TEAM_GAURDTRP,TEAM_MAND,TEAM_SDWLEAD,TEAM_SDWMEM,TEAM_MARLEAD,TEAM_MARTRP,TEAM_DUA, TEAM_SIEGE, TEAM_MEDMM, TEAM_JAGUAR, TEAM_GUARD, TEAM_CLONE, TEAM_SDWOFF,TEAM_SDWSGT,TEAM_CVLD,TEAM_CVSPC,TEAM_CVTRP}
		},

		{
			Name  = "Level 3",
			Color = Color(0, 255, 0),
			Teams = { TEAM_CTSDSGT, TEAM_ASSISTANTMEDICALDIRECTOR,TEAM_WALONVAU,TEAM_KALSKIRATA,TEAM_FENRAU, TEAM_MEDICALDIRECTOR, TEAM_501STCOMMANDER, TEAM_501STEXECUTIVEOFFICER, TEAM_501STMAJOR, TEAM_212THCOMMANDER, TEAM_212THEXECUTIVEOFFICER, TEAM_212THMAJOR, TEAM_GREENCOMMANDER, TEAM_GREENEXECUTIVEOFFICER, TEAM_GREENMAJOR, TEAM_CGCOMMANDER, TEAM_CGEXECUTIVEOFFICER, TEAM_CGMJR, TEAM_GMCOMMANDER, TEAM_GMEXECUTIVEOFFICER, TEAM_GMMAJOR, TEAM_ARCCOMMANDER, TEAM_ARCEXECUTIVEOFFICER, TEAM_ARCMAJOR, TEAM_CECOMMANDER, TEAM_CEEXECUTIVEOFFICER, TEAM_CECHIEF, TEAM_ARCCOLT, TEAM_ARCHAVOC, TEAM_RCBOSS, TEAM_RCFIXER, TEAM_RCSEV, TEAM_RCSCORCH, TEAM_CRCHIEFTAIN, TEAM_CRUNDERCHIEF, TEAM_CREXECUTOR, TEAM_JEDICOUNCIL, TEAM_JEDITGCHIEF, TEAM_SENATE, TEAM_SENATECPT, TEAM_SHADOWMJR, TEAM_SHADOWEXO, TEAM_SHADOWCO, TEAM_NSOCPT, TEAM_NSOA, TEAM_NSOMED, TEAM_NSOCQC,TEAM_SDWCO,TEAM_SDWXO,TEAM_SDWMJR}
		},

		{
			Name  = "Level 4",
			Color = Color(200, 0, 255),
			Teams = {TEAM_MEDICALGENERAL, TEAM_RCADVISOR,TEAM_MCOVAU, TEAM_501STGENERAL, TEAM_212THGENERAL, TEAM_GREENGENERAL, TEAM_CGGENERAL, TEAM_GMGENERAL, TEAM_ARCGENERAL, TEAM_CEGENERAL, TEAM_RCGENERAL, TEAM_SHADOWGENERAL, TEAM_WPGENERAL, TEAM_501STMCOMMANDER, TEAM_212THMCOMMANDER, TEAM_GREENMCOMMANDER, TEAM_CGMCOMMANDER, TEAM_GMMCOMMANDER, TEAM_ARCMCOMMANDER, TEAM_CEMCOMMANDER, TEAM_ARCMC, TEAM_RCMCO, TEAM_ARCHHARBINGER, TEAM_MEDICALMCO, TEAM_BATTALIONGENERAL, TEAM_ASSISTANTBATTALIONGENERAL, TEAM_JEDIGRANDMASTER, TEAM_GCGRANDMASTER, TEAM_JEDIGENERALSKYWALKER, TEAM_501STGENERALSKYWALKER, TEAM_JEDIGENERALOBI, TEAM_212THGENERALOBI, TEAM_JEDIGENERALWINDU, TEAM_JEDIGENERALTANO, TEAM_501STGENERALTANO, TEAM_JEDIGENERALPLO, TEAM_WPGENERALPLO, TEAM_JEDIGENERALKIT, TEAM_RCGENERALKIT, TEAM_JEDIGENERALAAYLA, TEAM_327THGENERALAAYLA, TEAM_JEDIGENERALSHAAK, TEAM_CGGENERALSHAAK, TEAM_JEDIGENERALADI, TEAM_GMGENERALADI, TEAM_JEDIGENERALVOS, TEAM_SHADOWGENERALVOS, TEAM_JEDIGENERALLUMINARA, TEAM_JEDIGENCINDRALLIG, TEAM_CGJEDICHIEF, TEAM_GCGENERALLUMINARA, TEAM_ARCOFFICER, TEAM_GMOFFICER, TEAM_GREENOFFICER, TEAM_SHADOWOFFICER, TEAM_212THOFFICER, TEAM_501STOFFICER, TEAM_CROFFICER, TEAM_SENATEADV, TEAM_SHADOWMCO, TEAM_NSOADV,TEAM_SDWGENERAL,TEAM_SDWMCO,TEAM_FLEETLIEUTENANT,TEAM_FLEETMEMBERSNR,TEAM_FLEET_IO,TEAM_FLEET_IOA,TEAM_FLEET_RDM,TEAM_FLEET_RDE,TEAM_FLEETRECRUIT,TEAM_FLEETMEMBER}
		},

		{
			Name  = "Level 5",
			Color = Color(169, 169, 169),
			Teams = { TEAM_FLEETADMIRAL, TEAM_GRANDADMIRAL, TEAM_SUPREMEGENERAL, TEAM_JEDIGRANDMASTER, TEAM_GCGRANDMASTER, TEAM_SOD, TEAM_EH, TEAM_REPUBLICCHARACTER, TEAM_RSBMEMBER}
		},
