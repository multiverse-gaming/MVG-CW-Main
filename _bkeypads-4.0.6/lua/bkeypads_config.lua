	...
	Levels = {
...

		{
			...
			Teams = {
				...
				TEAM_RCGRINDER, TEAM_RCGRIP, TEAM_RCKURZ, TEAM_RCWATSON, TEAM_CDCPT,TEAM_CDOFF,TEAM_GAURDL,TEAM_GAURDTRP,TEAM_CDSGT,TEAM_CDTRP,TEAM_MAND,TEAM_SDWLEAD,TEAM_SDWMEM,TEAM_MARLEAD,TEAM_MARTRP,TEAM_JEDICONGUARD,TEAM_JEDISENGUARD,TEAM_JEDIGUARGUARD,TEAM_DUA, TEAM_SIEGE, TEAM_MEDMM, TEAM_JAGUAR, TEAM_GUARD, TEAM_CLONE}
		},
