...
function ENT:Initialize()
	...
	self.Entity:SetNetworkedString( 14, "" .. sirensquadnames[sirensquadnumber] .. "" )
...
local ent = ents.Create( "Duel_of_the_Fates" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
local squad = self:GetNetworkedString( 14 )

self.Entity:EmitSound("Oogway/duel_of_the_fates.mp3",600)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Duel of the Fates activated")
end
...
self.Entity:StopSound("Oogway/duel_of_the_fates.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Duel of the Fates deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Duel of the Fates removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
