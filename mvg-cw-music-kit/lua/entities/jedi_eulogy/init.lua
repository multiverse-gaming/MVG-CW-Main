...
local ent = ents.Create( "jedi_eulogy" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
self.Entity:EmitSound("mvg_music/jedi_eulogy.mp3",600)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Jedi Eulogy activated")
end
...
self.Entity:StopSound("mvg_music/jedi_eulogy.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Jedi Eulogy deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Jedi Eulogy removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
