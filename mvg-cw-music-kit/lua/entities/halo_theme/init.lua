...
local ent = ents.Create( "halo_theme" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
self.Entity:EmitSound("Oogway/halo_theme.mp3",600)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Halo Theme activated")
end
...
self.Entity:StopSound("Oogway/halo_theme.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Halo Theme deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Halo Theme removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
