...
local ent = ents.Create( "into_the_breach" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
self.Entity:EmitSound("mvg_music/into_the_breach.mp3",600)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Into The Breach activated")
end
...
self.Entity:StopSound("mvg_music/into_the_breach.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Into The Breach deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Into The Breach removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
