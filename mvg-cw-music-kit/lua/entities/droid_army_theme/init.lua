...
function ENT:Initialize()
	...
	self.Entity:SetNetworkedString( 13, "" .. sirensquadnames[sirensquadnumber] .. "" )
...
local ent = ents.Create( "droid_army_theme" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
local squad = self:GetNetworkedString( 13 )

self.Entity:EmitSound("Oogway/droid_army_theme.mp3",600)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Droid Army Theme activated")
end
...
self.Entity:StopSound("Oogway/droid_army_theme.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Droid Army Theme deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Droid Army Theme removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
