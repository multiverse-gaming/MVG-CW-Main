...
local ent = ents.Create( "clone_sacrifice" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
self.Entity:EmitSound("mvg_music/clone_sacrifice.mp3",600)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Clone Sacrifice activated")
end
...
self.Entity:StopSound("mvg_music/clone_sacrifice.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Clone Sacrifice deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Clone Sacrifice removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
