...
local ent = ents.Create( "anakin_to_ahsoka" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
self.Entity:EmitSound("mvg_music/anakin_to_ahsoka.mp3",600)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Anakin To Ahsoka activated")
end
...
self.Entity:StopSound("mvg_music/anakin_to_ahsoka.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Anakin To Ahsoka deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Anakin To Ahsoka removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
