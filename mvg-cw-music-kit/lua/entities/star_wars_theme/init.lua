...
function ENT:Initialize()
	...
	self.Entity:SetNetworkedString( 17, "" .. sirensquadnames[sirensquadnumber] .. "" )
...
local ent = ents.Create( "star_wars_theme" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
local squad = self:GetNetworkedString( 17 )

self.Entity:EmitSound("Oogway/star_wars_theme.mp3",600)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Star Wars Theme activated")
end
...
self.Entity:StopSound("Oogway/star_wars_theme.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Star Wars Theme deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Star Wars Theme removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
