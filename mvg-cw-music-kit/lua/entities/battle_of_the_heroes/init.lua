...
function ENT:Initialize()
	...
	self.Entity:SetNetworkedString( 11, "" .. sirensquadnames[sirensquadnumber] .. "" )
...
local ent = ents.Create( "battle_of_the_heroes" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
local squad = self:GetNetworkedString( 11 )

self.Entity:EmitSound("Oogway/battle_of_the_heroes.mp3",600)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Battle of The Heroes activated")
end
...
self.Entity:StopSound("Oogway/battle_of_the_heroes.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Battle of The Heroes deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Battle of The Heroes removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
