...
function ENT:Initialize()
	...
	self.Entity:SetNetworkedString( 15, "" .. sirensquadnames[sirensquadnumber] .. "" )
...
local ent = ents.Create( "general_grevious_theme_2003" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
local squad = self:GetNetworkedString( 15 )

self.Entity:EmitSound("Oogway/general_grevious_theme_2003.mp3",600)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "General Grevious Theme activated")
end
...
self.Entity:StopSound("Oogway/general_grevious_theme_2003.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "General Grevious Theme deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "General Grevious Theme removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
