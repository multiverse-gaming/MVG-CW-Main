...
function ENT:Initialize()
	...
	self.Entity:SetNetworkedString( 18, "" .. sirensquadnames[sirensquadnumber] .. "" )
...
local ent = ents.Create( "the_force_theme" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
local squad = self:GetNetworkedString( 18 )

self.Entity:EmitSound("Oogway/the_force_theme.mp3",600)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "The Force Theme activated")
end
...
self.Entity:StopSound("Oogway/the_force_theme.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "The Force Theme deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "The Force Theme removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
