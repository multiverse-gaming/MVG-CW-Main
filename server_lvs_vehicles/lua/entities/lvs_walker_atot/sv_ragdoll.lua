...
function ENT:BecomeRagdoll()
	...
	local legs = {
		[1] = {
			...
			pos = Vector(220,100,155.76),
			ang = Angle(144.215007781982,160.94340515137,63.648578643799),
			constraintent = 0,
			relative = self,
			mass = 1000,
		},
		...
		[3] = {
			mdl = "models/blu/atte_bigleg.mdl",
			pos = Vector(220,-100,155.76),
			ang = Angle(107.58911895752,-85.624977111816,-4.3076190948486),
			constraintent = 0,
			relative = self,
			mass = 1000,
		},
		[4] = {
			mdl = "models/blu/atte_bigfoot.mdl",
			pos = Vector(200,-85.04605102539,75.999664306641),
			ang = Angle(-0,180,-0),
			constraintent = 3,
			relative = self,
			mass = 5000,
		...
		[12] = {
			mdl = "models/blu/atte_bigfoot.mdl",
			pos = Vector(60.5,-85.04605102539,75.999664306641),
			ang = Angle(-0,180,-0),
			constraintent = 11,
			relative = self,
			mass = 5000,
		...
		[14] = {
			mdl = "models/blu/atte_bigfoot.mdl",
			pos = Vector(-90.5,-85.04605102539,75.999664306641),
			ang = Angle(-0,180,-0),
			constraintent = 13,
			relative = self,
			mass = 5000,
		...
		[16] = {
			mdl = "models/blu/atte_bigfoot.mdl",
			pos = Vector(-230.5,-85.04605102539,75.999664306641),
			ang = Angle(-0,180,-0),
			constraintent = 15,
			relative = self,
			mass = 5000,
