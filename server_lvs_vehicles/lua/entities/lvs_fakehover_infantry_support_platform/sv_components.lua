function ENT:AddWheel( pos, radius, mass, buoyancyratio, brakeforce, OnCollision, ply )
	...
	debugoverlay.Sphere( WheelPos, radius, 30, Color(255, 255, 255 ), true )
	debugoverlay.Line( CenterPos, WheelPos, 30, Color(255, 255, 255 ), true )
	...
	wheel:Define( 
		{
			radius = radius,
			mass = mass,
			buoyancyratio = buoyancyratio or 10,
		}
	)
