...
ENT.PrintName = "LAAT/i Spec-Ops"
ENT.Author = "Luna"
ENT.Information = "Gunship of the Galactic Republic"
...
ENT.TurnRatePitch = 0.9//0.7
ENT.TurnRateYaw = 0.9//0.7
