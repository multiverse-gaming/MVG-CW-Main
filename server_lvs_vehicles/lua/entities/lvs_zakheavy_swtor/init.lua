...
function ENT:OnSpawn( PObj )
	...
	local DriverSeat = self:AddDriverSeat( Vector(-350,0,300), Angle(0,-90,0) )
	DriverSeat:SetCameraDistance( 2.3 )
	...
	local Pod = self:AddPassengerSeat( Vector(-350,0,250), Angle(0,-90,0) )
	 ...
	 local Pod = self:AddPassengerSeat( Vector(-350,50,275), Angle(0,-90,0) )
 	Pod.HidePlayer = true 

	local Pod = self:AddPassengerSeat( Vector(-350,50,250), Angle(0,-90,0) )
 	Pod.HidePlayer = true 
