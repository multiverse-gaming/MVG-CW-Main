...
function ENT:Draw()
	...
	if self:GetEngineActive() then
		...
		render.DrawSprite( self:LocalToWorld( Vector(-92.869,-2.103,114.53) ), Size, Size, Color( 0, 255, 157, 255) )	
	...
	if self:GetEngineActive() then
		...
		local Size = 40
		render.SetMaterial( mat )
		render.DrawSprite( self:LocalToWorld( Vector(49.727,-31.792,138.921) ), Size, Size, Color( 0, 255, 157, 255) )
		render.DrawSprite( self:LocalToWorld( Vector(49.727,31.792,138.921) ), Size, Size, Color( 0, 255, 157, 255) )

		render.DrawSprite( self:LocalToWorld( Vector(-93,-21.518,124.538) ), Size, Size, Color( 0, 255, 157, 255) )
		render.DrawSprite( self:LocalToWorld( Vector(-93,18.518,124.538) ), Size, Size, Color( 0, 255, 157, 255) )
		
		render.DrawSprite( self:LocalToWorld( Vector(-91.684,-18.785,110.853) ), Size, Size, Color( 0, 255, 157, 255) )
		render.DrawSprite( self:LocalToWorld( Vector(-91.684,15.785,110.853) ), Size, Size, Color( 0, 255, 157, 255) )
...
function ENT:DamageFX()
	...
	if self.nextDFX < CurTime() then
		...
		local effectdata = EffectData()
			effectdata:SetOrigin( self:LocalToWorld( Vector(-85.869,-2.103,114.53) ) )
