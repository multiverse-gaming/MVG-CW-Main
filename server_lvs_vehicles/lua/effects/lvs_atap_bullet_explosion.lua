...
function EFFECT:Init( data )
	...
	for i = 0,30 do
		...
		if particle then
			...
			particle:SetStartSize( math.Rand(230,260) )
	...
	for i = 0, 20 do
		...
		if particle then
			...
			particle:SetStartSize( math.Rand(224,234) )
	...
	for i = 0, 40 do
		...
		if particle then
			...
			particle:SetEndSize( math.Rand(230,260) )
...
function EFFECT:Render()
	...
	render.DrawSprite( self.Pos, 500 * Scale, 500 * Scale, Color( 0, 127, 255, 255) )
