...
function PANEL:PaintOver()
	...
	local r = xLib.Utils.ScreenScale(12)
	xLib.Utils.DrawHollowCircle(x + r/2, y + r/2, r, Color(0, 0, 0, 255))
end
...
function PANEL:OnUserChanged() end
...
derma.DefineControl("xLibColorCube", "", PANEL, "DSlider")