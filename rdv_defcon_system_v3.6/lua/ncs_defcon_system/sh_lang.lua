...
function NCS_DEFCON.AddLang(lang, note)
    RegisterLang(lang)
...
function NCS_DEFCON.GetLang(lang, note, replacements)
    if !lang then
        lang = NCS_DEFCON.CONFIG.languageSet or "en"
    end
...
function NCS_DEFCON.GetLanguages()
    return LANG
end