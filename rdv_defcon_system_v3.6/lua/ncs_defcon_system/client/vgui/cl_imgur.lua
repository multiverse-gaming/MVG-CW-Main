...
function PANEL:Paint(w, h)
    ...
    if not self:IsEnabled() then
        NCS_DEFCON.DrawImgur(imageOffsetW, imageOffset, imageSize, imageSize, self:GetImgurID(), self:GetDisabledColor())
        return
    end
    ...
    NCS_DEFCON.DrawImgur(imageOffsetW, imageOffset, imageSize, imageSize, self:GetImgurID(), col)
end

vgui.Register("NCS_DEF_IMGUR", PANEL, "DButton")