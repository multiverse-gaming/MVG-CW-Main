...
function ENT:IsOwnerAllowed()
	...
	if (tonumber(npcspawner.config.adminonly) == 0) then
...
function ENT:Use(activator, caller)
	if activator:GetUserGroup() == "user" or activator:GetUserGroup() == "pac3" or activator:GetUserGroup() == "pacvip" or activator:GetUserGroup() == "veteran" or activator:GetUserGroup() == "advisor" or activator:GetUserGroup() == "developer" then
		return
	end 
