CreateConVar("arccw_enable_penetration", 0, FCVAR_ARCHIVE + FCVAR_REPLICATED, "", 0, 1)
CreateConVar("arccw_enable_ricochet", 0, FCVAR_ARCHIVE + FCVAR_REPLICATED, "", 0, 1)
CreateConVar("arccw_enable_customization", 1, FCVAR_ARCHIVE + FCVAR_REPLICATED, "", -1, 1)
CreateConVar("arccw_enable_dropping", 0, FCVAR_ARCHIVE + FCVAR_REPLICATED, "", 0, 1)
...
CreateConVar("arccw_attinv_lockmode", 1, FCVAR_REPLICATED, "Once owned, players can use attachments as much as they like.")
CreateConVar("arccw_attinv_free", 0, FCVAR_REPLICATED, "All attachments can always be used.")
CreateConVar("arccw_attinv_loseondie", 1, FCVAR_REPLICATED, "All attachments reset on death. If set to 2, drops all attachments in a box.", 0, 2)
...
CreateConVar("arccw_override_hud_off", 1, FCVAR_ARCHIVE + FCVAR_REPLICATED, "Set to true to force everyone's HUDs off.", 0, 1)
CreateConVar("arccw_override_nearwall", 0, FCVAR_ARCHIVE + FCVAR_REPLICATED, "Disable weapon length and near-walling.", 0, 1)
CreateConVar("arccw_override_lunge_off", 1, FCVAR_ARCHIVE + FCVAR_REPLICATED, "Disable melee lunging.", 0, 1)
...
CreateConVar("arccw_weakensounds", -7, FCVAR_ARCHIVE + FCVAR_REPLICATED, "Reduce all weapons' firing volume by this much decibels, making it easier to hide shooting sounds. Clamped to 60-150dB.")
...
CreateConVar("arccw_malfunction", 0, FCVAR_ARCHIVE + FCVAR_REPLICATED, "", 0, 2)
