...
local jobs = {
    ...
    -- WP
    ["Wolfpack General"] = {"underbarrel_scandart", "underbarrel_scandartt_local"},
    ["Wolfpack Marshal Commander"] = {"underbarrel_scandart", "underbarrel_scandartt_local"},
    ["Wolfpack Commander"] = {"underbarrel_scandart", "underbarrel_scandartt_local"},
    ["Wolfpack Executive Officer"] = {"underbarrel_scandart", "underbarrel_scandartt_local"},
    ["Wolfpack Major"] = {"underbarrel_scandart", "underbarrel_scandartt_local"},
    ["Wolfpack Direwolf"] = {"underbarrel_scandart", "underbarrel_scandartt_local"},
