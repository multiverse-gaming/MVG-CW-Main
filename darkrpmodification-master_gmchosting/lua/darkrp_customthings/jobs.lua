...
TEAM_WPGENERAL = DarkRP.createJob("Wolfpack General", {
    ...
    weapons = {"arccw_duals_dc17ext_v2", "arccw_cr2c", "arccw_cr2", "arccw_dc17_v2_scandart", "realistic_hook", "arccw_hunter_shotgun", "arccw_valken38x_v2", "weapon_thruster","weapon_remotedrone","datapad_player"},
...
TEAM_ARCMCOMMANDER = DarkRP.createJob("Wolfpack Marshal Commander", {
    ...
    weapons = {"arccw_cr2c", "arccw_cr2",  "arccw_dc17_v2_scandart", "arccw_duals_dc17ext_v2", "arccw_hunter_shotgun", "arccw_valken38x_v2", "weapon_thruster","realistic_hook"},
...
TEAM_ARCPATHFINDER = DarkRP.createJob("Wolfpack Pathfinder", {
    ...
    weapons = {"arccw_dc17_v2","arccw_valken38x_v2", "arccw_cr2c",  "arccw_dc17_v2_scandart", "weapon_jetpack"},
