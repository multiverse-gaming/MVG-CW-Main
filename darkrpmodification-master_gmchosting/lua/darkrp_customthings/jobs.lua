...
TEAM_SUPREMEGENERAL = DarkRP.createJob("Supreme General", {
    ...
    weapons = {"masita_e11d", "arccw_v2_dc15x", "arccw_v2_duals_dc17ext_stun", "arccw_sw_rocket_rps6", "realistic_hook", "weapon_jew_stimkit", "weapon_remotedrone","datapad_player", "carkeys"},
    command = "sg",
    max = 1,
    salary = 300,
    admin = 0,
