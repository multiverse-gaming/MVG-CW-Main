...
DarkRP.createEntity("Medical Stretcher", {
    ent = "swrp_stretcher",
    model = "models/props/starwars/medical/medical_bed.mdl",
    price = 0,
    max = 1,
    cmd = "stretcher",
    allowed = {TEAM_FLEETMO, TEAM_MEDICALGENERAL, TEAM_ASSISTANTMEDICALDIRECTOR, TEAM_JEDIGENERALWINDU, TEAM_JEDICONSULAR, TEAM_501STMEDOFFICER, TEAM_501STMEDTROOPER, TEAM_212THMEDTROOPER, TEAM_212THMEDOFFICER, TEAM_GREENMEDTROOPER, TEAM_GREENMEDOFFICER, TEAM_CGMEDOFFICER, TEAM_CGMEDTROOPER, TEAM_GMMEDTROOPER, TEAM_GMMEDOFFICER, TEAM_ARCMEDTROOPER, TEAM_ARCMEDOFFICER, TEAM_CEMEDOFFICER, TEAM_CEMEDTROOPER, TEAM_MEDICALDIRECTOR, TEAM_ASSISTANTMEDICALDIRECTOR, TEAM_MEDICALGENERAL,TEAM_FLEET_DRD,TEAM_FLEET_RD},
    category = "Entities",
})
...
--[[DarkRP.createEntity("AT-TE", {
    ent = "kingpommes_lfs_atte",
    model = "models/blu/atte.mdl",
    price = 0,
    max = 1,
    cmd = "atte",
    allowed = {TEAM_212THCOMMANDER, TEAM_212THEXECUTIVEOFFICER, TEAM_212THMAJOR, TEAM_212THGENERAL, TEAM_212THOFFICER},
    category = "Entities",
})
local function TX130(ply,tr)
    local speeder = ents.Create("lunasflightschool_iftx")
    speeder:SetPos(tr.HitPos)
    speeder:SetBodygroup(0, 1)
    speeder:SetSkin(0)
    speeder:Spawn()
    speeder:Activate()
    return speeder
...
local function TXTurret(ply,tr)
    local tank = ents.Create("lunasflightschool_iftx")
    tank:SetPos(tr.HitPos)
    tank:SetBodygroup(0, 1)
    tank:SetSkin(0, 1)
    tank:Spawn()
    tank:Activate()
    return tank
...
DarkRP.createEntity("TX-130 TURRET", {
    ent = "lunasflightschool_iftx",
    model = "models/blu/iftx.mdl",
    price = 0,
    max = 1,
    ...
    category = "Entities",
    spawn = function( ply, tr, tblEnt )
        return TXTurret(ply,tr)
    end
})

DarkRP.createEntity("TX-427", {
    ent = "lunasflightschool_niksacokica_tx-427",
    model = "models/lfs_vehicles/tx427/tx427_static.mdl",
    price = 0,
    max = 1,
    cmd = "tx427",
    allowed = {TEAM_212THHEAVYTROOPER, TEAM_212THCOMMANDER, TEAM_212THEXECUTIVEOFFICER, TEAM_212THMAJOR, TEAM_212THGENERAL, TEAM_212THSPECIALIST},
    category = "Entities"
}) ]]--
