...
DarkRP.createEntity("Keypad Battery", {
    ...
    max = 2,
    cmd = "kpb",
    allowed = {TEAM_FLEET_RDE,TEAM_CEMECHANIC, TEAM_CECHIEF, TEAM_CEMCOMMANDER, TEAM_CECOMMANDER, TEAM_CELIEUTENANT,TEAM_JEDICOUNCIL, TEAM_CESPECIALIST, TEAM_CEEXECUTIVEOFFICER, TEAM_CETROOPER, TEAM_CEFAB, TEAM_RCTECH,TEAM_RCATIN, TEAM_JEDISENTINEL, TEAM_327THJEDI, TEAM_501STJEDI, TEAM_212THJEDI, TEAM_327THGENERALAAYLA, TEAM_JEDICOUNCIL, TEAM_CEGENERAL, TEAM_RCFIXER, TEAM_CEARC, TEAM_ARCALPHACE, TEAM_CEMEDOFFICER, TEAM_CEMEDTROOPER, TEAM_CEMEDOFFICER, TEAM_CEMEDTROOPER, TEAM_JEDIGENERALAAYLA, TEAM_JEDISENGUARD, TEAM_G,TEAM_FLEET_DRD,TEAM_FLEET_RD},
    category = "Entities",
})
...
DarkRP.createEntity("Keypad Shield", {
    ...
    max = 2,
    cmd = "kps",
    allowed = {TEAM_FLEET_RDE,TEAM_CEMECHANIC, TEAM_CECHIEF, TEAM_CEMCOMMANDER, TEAM_CECOMMANDER,TEAM_RCTECH, TEAM_JEDICOUNCIL, TEAM_CELIEUTENANT, TEAM_CESPECIALIST, TEAM_CEFAB, TEAM_CEEXECUTIVEOFFICER, TEAM_JEDISENTINEL, TEAM_327THJEDI, TEAM_501STJEDI, TEAM_212THJEDI, TEAM_327THGENERALAAYLA, TEAM_CEGENERAL, TEAM_CEARC, TEAM_ARCALPHACE, TEAM_CEMEDOFFICER, TEAM_CEMEDTROOPER, TEAM_JEDIGENERALAAYLA, TEAM_JEDISENGUARD,TEAM_FLEET_DRD,TEAM_FLEET_RD},
    category = "Entities",
})
...
DarkRP.createEntity("Hacking Tools", {
    ...
    max = 1,
    cmd = "hackingtools",
    allowed = {TEAM_CECHIEF, TEAM_RCECHO, TEAM_CEMCOMMANDER, TEAM_CECOMMANDER, TEAM_CEMECHANIC, TEAM_RCTECH, TEAM_CELIEUTENANT, TEAM_CESPECIALIST, TEAM_CEEXECUTIVEOFFICER, TEAM_CETROOPER, TEAM_CEFAB, TEAM_RCTECH, TEAM_JEDISENTINEL, TEAM_327THJEDI, TEAM_501STJEDI, TEAM_212THJEDI, TEAM_327THGENERALAAYLA, TEAM_JEDICOUNCIL, TEAM_CEGENERAL, TEAM_RCFIXER, TEAM_CEARC, TEAM_ARCALPHACE, TEAM_CEMEDOFFICER, TEAM_CEMEDTROOPER, TEAM_JEDIGENERALAAYLA, TEAM_JEDISENGUARD},
    category = "Entities",
})
...
DarkRP.createEntity("XP Holocron", {
    ...
    max = 1,
    cmd = "xphol",
    allowed = {TEAM_JEDIGRANDMASTER, TEAM_GCGRANDMASTER, TEAM_JEDIGENERALSKYWALKER, TEAM_501STGENERALSKYWALKER, TEAM_JEDIGENERALOBI, TEAM_212THGENERALOBI, TEAM_JEDIGENERALWINDU, TEAM_JEDIGENERALTANO, TEAM_501STGENERALTANO, TEAM_JEDIGENERALPLO, TEAM_WPGENERALPLO, TEAM_JEDIGENERALKIT, TEAM_RCGENERALKIT, TEAM_JEDIGENERALAAYLA, TEAM_327THGENERALAAYLA, TEAM_JEDIGENERALSHAAK, TEAM_CGGENERALSHAAK, TEAM_JEDIGENERALADI, TEAM_GMGENERALADI, TEAM_JEDIGENERALVOS, TEAM_SHADOWGENERALVOS, TEAM_JEDIGENERALLUMINARA, TEAM_GCGENERALLUMINARA, TEAM_JEDICOUNCIL},
    category = "Entities",
})
...
DarkRP.createEntity("Knight Hilt Blueprint", {
    ...
    max = 1,
    cmd = "knighthilt",
    allowed = {TEAM_JEDICOUNCIL, TEAM_JEDIGENERALLUMINARA, TEAM_JEDIGENERALADI, TEAM_JEDIGENERALSHAAK, TEAM_JEDIGENERALAAYLA, TEAM_JEDIGENERALKIT, TEAM_JEDIGENERALPLO, TEAM_JEDIGENERALTANO, TEAM_JEDIGENERALWINDU, TEAM_JEDIGENERALOBI, TEAM_JEDIGENERALSKYWALKER, TEAM_JEDIGRANDMASTER, TEAM_JEDIGENERALVOS },
    category = "Entities",
})
