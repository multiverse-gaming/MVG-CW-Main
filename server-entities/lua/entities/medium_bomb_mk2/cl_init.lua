...
function DrawTheMenuMKIIM()-- the function to call when the usermessage is received-- your derma stuff goes in this function..local DFrame1 = vgui.Create('DFrame')
...
usermessage.Hook( "DrawTheMenuMKIIM", DrawTheMenuMKIIM )
