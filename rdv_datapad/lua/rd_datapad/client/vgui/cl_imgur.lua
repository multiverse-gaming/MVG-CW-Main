...
function PANEL:Paint(w, h)
    ...
    if not self:IsEnabled() then
        NCS_DATAPAD.DrawImgur(imageOffsetW, imageOffset, imageSize, imageSize, self:GetImgurID(), self:GetDisabledColor())
        return
    end
    ...
    NCS_DATAPAD.DrawImgur(imageOffsetW, imageOffset, imageSize, imageSize, self:GetImgurID(), col)
end
