return {
	...
	heal_help = "Heals player(s) back to their max health.",
	...
	unmodel = "{A} set the model for {T} to default model",



	setmodel = "{A} set the model for {T} to {V}.",

	seteventmodel = "{A} set the event model for {T} to {V}",

	setmodel_help = "Change player(s)'s model.",



	no_setmodel = "{A}, you can't player(s) model with {V}.",
	
	
	eventprimary = "{A} gave {V} to {T}.",
	
	eventsecondary = "{A} gave {V} to {T}.",

	eventprimary_help = "Give player's a weapon until they change job.",
	
	eventsecondary_help = "Give player's another weapon until they change job.",

	
	eventhealth = "{A} set {V} health to {T}.",
	
	eventhealth_help = "Set player's health until they change job.",



	no_eventweapon = "{A}, you can't give {V}.",
	...
	givetac = "{A} gave {T} a tactical insert.",
	
	givetac_help = "Give player(s) a tac.",


	givereg_help = "Give's a regiment weapon/entity",

	givereg = "{A} gave {T} {V}.",
	
	givereg_toomany = "Too many categories to use command, the following names: {A}.",

	givereg_nofound = "No categories found",

	clearpac = "{A} has clear pac for {T}",

	clearpac_help = "Clear pac for player(s) | NOTE: If clearpacall doesn't work for the player please report this to a senior+/dev+ immediately",
	
	clearpacall = "{A} has clear pac for all users",
	
	clearpac_help = "Clear pac for all players | NOTE: If clearpac doesn't work for the player please report this to a senior+/dev+ immediately",
	...
	setspawn = "{A} updated a spawn position",

	setspawn_help = "Update a job's spawn position",
	...
	nottarget_help = "No targets players.",

	un_nottarget_help = "Un-no targets players",



	nottarget = "{A} notargeted {T}",



	un_nottarget = "{A} unnotargeted {T}",
