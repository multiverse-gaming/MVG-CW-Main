...
hook.Add("InitPostEntity","AddViewClaims", function()
	if LocalPlayer():GetUserGroup() == "activedeveloper" or LocalPlayer():GetUserGroup() == "headadmin" or LocalPlayer():GetUserGroup() == "superadmin" then 
