local OBJ = RDV.VEHICLE_REQ.AddSpawn("Landing Pad 1")
...
OBJ:SetPosition(Vector(3284.869385, 5227.844727, -13747.000000))


OBJ:SetAngles(Angle(5.280207, 0.581790, 0.000000))
