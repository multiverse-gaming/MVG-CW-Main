local OBJ = RDV.VEHICLE_REQ.AddSpawn("Landing Pad 14")
...
OBJ:SetPosition(Vector(-6491.914551, 79.458321, 128.031250))


OBJ:SetAngles(Angle(3.001646, -179.374374, 0.000000))
