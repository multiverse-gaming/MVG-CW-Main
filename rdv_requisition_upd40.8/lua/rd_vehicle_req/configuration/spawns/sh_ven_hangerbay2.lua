local OBJ = RDV.VEHICLE_REQ.AddSpawn("Hanger Bay Two")
...
OBJ:SetPosition(Vector(3865.315918, 1173.262695, 3847.031250))


OBJ:SetAngles(Angle(-3.967718, 91.893280, 0.000000))
