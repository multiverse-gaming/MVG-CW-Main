local OBJ = RDV.VEHICLE_REQ.AddSpawn("Jedi Temple Pad 2")
...
OBJ:SetPosition(Vector( 12492.152344, 5183.299316, -8932.169922))


OBJ:SetAngles(Angle(-2.904011, 131.660095 , 0.000000))
