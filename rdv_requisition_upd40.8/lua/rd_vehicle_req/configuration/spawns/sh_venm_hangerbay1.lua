local OBJ = RDV.VEHICLE_REQ.AddSpawn("Hanger Bay 1")
...
OBJ:SetPosition(Vector(-1685.856812, -1653.886475, -1405.968750))


OBJ:SetAngles(Angle(6.864264, 88.391571, 0.000000))
