local OBJ = RDV.VEHICLE_REQ.AddSpawn("Hanger Bay One")
...
OBJ:SetPosition(Vector( 3870.304932, -1168.765381, 3847.031250))


OBJ:SetAngles(Angle(-4.495713, -89.078682, 0.000000))
