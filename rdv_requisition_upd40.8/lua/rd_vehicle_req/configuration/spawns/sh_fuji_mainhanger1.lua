local OBJ = RDV.VEHICLE_REQ.AddSpawn("Main Hanger One")
...
OBJ:SetPosition(Vector(-14007.559570, -11281.896484, 1760.031250))


OBJ:SetAngles(Angle(6.864000, -93.816124, 0.000000))
