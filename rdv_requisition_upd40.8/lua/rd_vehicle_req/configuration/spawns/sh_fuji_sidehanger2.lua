local OBJ = RDV.VEHICLE_REQ.AddSpawn("Side Hanger Two")
...
OBJ:SetPosition(Vector(-8484.731445, -8469.368164, 384.031250))


OBJ:SetAngles(Angle(4.355933, 92.051498, 0.000000))
