local OBJ = RDV.VEHICLE_REQ.AddSpawn("Landing Bay Seven")
...
OBJ:SetPosition(Vector(-4337.644531, -1088.772949, 4071.031250))


OBJ:SetAngles(Angle(0.388240, 89.337151, 0.000000))
