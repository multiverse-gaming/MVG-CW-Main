local OBJ = RDV.VEHICLE_REQ.AddSpawn("Fleet Hanger 1")
...
OBJ:SetPosition(Vector(246.686401, 577.409607, -1293.968750))


OBJ:SetAngles(Angle(1.188001, 176.831650, 0.000000))
