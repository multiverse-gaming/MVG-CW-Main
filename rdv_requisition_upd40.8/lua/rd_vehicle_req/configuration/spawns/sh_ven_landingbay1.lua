...
local OBJ = RDV.VEHICLE_REQ.AddSpawn("Landing Bay One")
...
OBJ:SetPosition(Vector(-1639.680298, -1098.349243, 4071.031250))


OBJ:SetAngles(Angle(-0.139719, 89.421234, 0.000000))
