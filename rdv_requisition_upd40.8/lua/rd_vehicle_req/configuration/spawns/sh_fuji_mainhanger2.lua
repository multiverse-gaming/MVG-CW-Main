local OBJ = RDV.VEHICLE_REQ.AddSpawn("Main Hanger Two")
...
OBJ:SetPosition(Vector(-12279.565430, -12672.356445, 1760.038208))


OBJ:SetAngles(Angle(8.052000, 88.379822, 0.000000))
