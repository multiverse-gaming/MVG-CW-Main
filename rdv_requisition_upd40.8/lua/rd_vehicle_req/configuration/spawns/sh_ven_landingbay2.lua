local OBJ = RDV.VEHICLE_REQ.AddSpawn("Landing Bay Two")
...
OBJ:SetPosition(Vector(-1608.491455, 980.721680, 4071.031250))


OBJ:SetAngles(Angle(0.388279, -89.570824, 0.000000))
