local OBJ = RDV.VEHICLE_REQ.AddSpawn("Secondary Hanger")
...
OBJ:SetPosition(Vector(855.357910, 3959.607178, -13776.191406))


OBJ:SetAngles(Angle(-1.420593, 2.879550, 0.000000))
