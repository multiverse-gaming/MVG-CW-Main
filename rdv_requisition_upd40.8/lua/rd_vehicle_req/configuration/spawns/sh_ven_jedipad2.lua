local OBJ = RDV.VEHICLE_REQ.AddSpawn("Jedi Landing Pad Two")
...
OBJ:SetPosition(Vector( -12883.137695, -12991.374023, -8911.968750))


OBJ:SetAngles(Angle(-0.528004, 91.596031, 0.000000))
