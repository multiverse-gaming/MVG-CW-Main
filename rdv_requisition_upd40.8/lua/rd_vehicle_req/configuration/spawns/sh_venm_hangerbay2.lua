local OBJ = RDV.VEHICLE_REQ.AddSpawn("Hanger Bay 2")
...
OBJ:SetPosition(Vector(-1669.894897, 532.679382, -1405.968750))


OBJ:SetAngles(Angle(6.069946, -91.916626, 0.000000))
