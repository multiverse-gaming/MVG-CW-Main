local OBJ = RDV.VEHICLE_REQ.AddSpawn("Landing Pad 2")
...
OBJ:SetPosition(Vector(3251.523193, 3007.922363, -13746.919922))


OBJ:SetAngles(Angle(5.940172, 2.165850, 0.000000))
