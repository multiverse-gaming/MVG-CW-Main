local OBJ = RDV.VEHICLE_REQ.AddSpawn("Tank Bay 2")
...
OBJ:SetPosition(Vector(2537.702637, 1372.161133, -1404.931274))


OBJ:SetAngles(Angle(0.396258, 358.055542, 0.000000))
