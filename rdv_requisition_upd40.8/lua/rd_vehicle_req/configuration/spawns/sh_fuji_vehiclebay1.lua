local OBJ = RDV.VEHICLE_REQ.AddSpawn("Vehicle Bay One")
...
OBJ:SetPosition(Vector(-4312.745605 ,-8554.399414 ,80.031250))


OBJ:SetAngles(Angle(3.960016, 177.623123, 0.000000))
