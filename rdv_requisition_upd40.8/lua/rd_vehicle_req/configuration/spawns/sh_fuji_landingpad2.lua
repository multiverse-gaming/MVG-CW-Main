local OBJ = RDV.VEHICLE_REQ.AddSpawn("Landing Pad Two")
...
OBJ:SetPosition(Vector(-2466.723389, -7319.124023, 144.031250))


OBJ:SetAngles(Angle(3.432039, -178.501282, 0.000000))
