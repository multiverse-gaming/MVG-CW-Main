local OBJ = RDV.VEHICLE_REQ.AddSpawn("Vehicle Bay 2")
...
OBJ:SetPosition(Vector(-5293.613281, 6092.200195, 128.031250))


OBJ:SetAngles(Angle(2.342125, 177.303391, 0.000000))
