local OBJ = RDV.VEHICLE_REQ.AddSpawn("Landing Pad 12")
...
OBJ:SetPosition(Vector(-11811.223633, 55.212208, 248.031250))


OBJ:SetAngles(Angle(0.229725, 0.577629, 0.000000))
