local OBJ = RDV.VEHICLE_REQ.AddSpawn("Vehicle Bay 1")
...
OBJ:SetPosition(Vector(-5164.871582, 5064.984863, 128.031250))


OBJ:SetAngles(Angle(7.226143, 179.679184, 0.000000))
