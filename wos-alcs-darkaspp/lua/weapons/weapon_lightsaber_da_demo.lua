...
SWEP.PrintName = "Dark Ascension Demo" --Name of the lightsaber
SWEP.Class = "weapon_lightsaber_da_test" --The file name of this swep
...
SWEP.ForcePowerList = { "Diamond Storm", "Energetic Shell", "Blood Sacrifice", "Crippling Slam", "Overdrive Beam", "Lightning Stream", "Burn Out", "Vitriolic Discharge", "Attract" } 
