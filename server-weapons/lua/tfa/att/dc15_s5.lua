...
ATTACHMENT.Name = "IQA-11 Scope"
ATTACHMENT.ShortName = "S5"
ATTACHMENT.Icon = "entities/att/s5.png"
...
ATTACHMENT.WeaponTable = {
	...
	["IronSightsPos"] = function( wep, val ) return wep.Scope5Pos or val, true end,
	["IronSightsAng"] = function( wep, val ) return wep.Scope5Ang or val, true end,
