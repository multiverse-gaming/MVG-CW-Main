...
ATTACHMENT.Name = "Zoom x12"
ATTACHMENT.ShortName = "x12" --Abbreviation, 5 chars or less please
--ATTACHMENT.ID = "base" -- normally this is just your filename
ATTACHMENT.Description = { 
	TFA.AttachmentColors["+"],"Add zoom x12",
}
...
ATTACHMENT.FOV = fov
ATTACHMENT.Reticule = "scope/gdcw_white_nobar" -- wep.ScopeReticule
