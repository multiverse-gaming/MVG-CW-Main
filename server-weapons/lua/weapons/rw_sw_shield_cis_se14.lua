...
SWEP.VElements = {
	["dc17"] = { type = "Model", model = "models/sw_battlefront/weapons/2019/se14_pistol.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(-0.5, 0, -02.95), angle = Angle(0, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["dc17"] = { type = "Model", model = "models/sw_battlefront/weapons/2019/se14_pistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.5, 1.2, -1.5), angle = Angle(0, -07, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}
