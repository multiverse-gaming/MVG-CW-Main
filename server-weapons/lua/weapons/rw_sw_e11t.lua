...
SWEP.IronSightsPos = Vector(-4.83, -8, 2.75)
...
SWEP.VElements = {
	["e11"] = { type = "Model", model = "models/rising/w_e11.mdl", bone = "v_e11_reference001", rel = "", pos = Vector(-1.95, 9, 2.5), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0]=1,[1]=1,[2]=1,[3]=1,[5]=1} },
	["scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_e11_reference001", rel = "e11", pos = Vector(1.07, -10.15, 2.532), angle = Angle(0, 90, 0), size = Vector(0.32, 0.32, 0.32), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["e11"] = { type = "Model", model = "models/rising/w_e11.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(10.5, 0, -05.2), angle = Angle(0, -90, 169), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0]=1,[1]=1,[2]=1,[3]=1,[5]=1} }
}
