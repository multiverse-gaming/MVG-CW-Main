...
SWEP.CrouchAccuracyMultiplier		= 0.05
...
SWEP.VElements = {
	...
	["trd"] = { type = "Model", model = "models/hunter/plates/plate025.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(0.8, 16.5, 6.2), angle = Angle(0, 90, 0), size = Vector(0.1, 0.07, 0.1), color = Color(255, 120, 0, 255), surpresslightning = true, material = "models/debug/debugwhite", skin = 0, bodygroup = {} }
 
}
 
SWEP.WElements = {
	["dc15a"] = { type = "Model", model = "models/sw_battlefront/weapons/dc15a_rifle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 0.4, -1), angle = Angle(-13, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}
