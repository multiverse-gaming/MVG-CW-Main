...
SWEP.PrintName						= "[AT] DC-15A (Heavy Mk.III)"
...
SWEP.Secondary.ClipSize				= 30*4
SWEP.Primary.DefaultClip			= 45*10
SWEP.Primary.RPM					= 350
SWEP.Primary.RPM_Burst				= 350*3.5
...
SWEP.Attachments = {
	[1] = {
		header = "Modes",
		atts = {"training_mod","destabilized_mod","explosive_mod"},
	},
	[2] = {
		header = "Scopes",
		atts = {"ammo_indicator","dc15_s3","dc15_s4"},
	},
	[3] = {
		header = "Muzzles",
		atts = {"dc15_muzzle1","dc15_muzzle2"},
	},
	[4] = {
		header = "Magazines",
		atts = {"dc15_dm","dc15_mxxl","dc15_mxl"},
	},
    [6] = {
		header = "Options2",
