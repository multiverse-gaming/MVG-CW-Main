...
SWEP.VElements = {
	["se14c"] = { type = "Model", model = "models/sw_battlefront/weapons/2019/se14_pistol.mdl", bone = "LeftHand_1stP", rel = "", pos = Vector(05, -1.5, -0.75), angle = Angle(-8, -2, 90), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["se14c+"] = { type = "Model", model = "models/sw_battlefront/weapons/2019/se14_pistol.mdl", bone = "RightHand_1stP", rel = "", pos = Vector(-5, 1.5, 0.75), angle = Angle(4, 178, 90), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}


SWEP.WElements = {
	["se14c"] = { type = "Model", model = "models/sw_battlefront/weapons/2019/se14_pistol.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(4.4, 1.5, -2), angle = Angle(0, -10, 2), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["se14c+"] = { type = "Model", model = "models/sw_battlefront/weapons/2019/se14_pistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4.4, 1.5, 2), angle = Angle(0, -9, 180), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
