...
SWEP.PrintName						= "[AT] DC-15SA Squad"
...
SWEP.Primary.Sound 					= Sound ("w/dc15sa.wav"); --w/dc15sa.wav

SWEP.Primary.ReloadSound 			= Sound ("w/dc15sa_reload.wav"); --w/dc15sa_reload.wav
...
SWEP.Attachments = {
	...
	--[[[1] = {atts = {"training_mod","destabilized_mod","explosive_mod","stun_mod"},order = 1}, --training_mod]]--

	[1] = {atts = {"dc15sa_holo","dc15_s4"},order = 1},

	--[[[2] = {atts = {"dc15sa_optimized_cell","dc15sa_overload_cell"},order = 2},--]]
