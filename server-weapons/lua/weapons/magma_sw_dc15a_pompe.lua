...
SWEP.Primary.Range 					= 40000/7
SWEP.Primary.RangeFalloff 			= -1
SWEP.Primary.NumShots				= 6
SWEP.Primary.Automatic				= false
SWEP.Primary.RPM_Semi				= nil
SWEP.Primary.BurstDelay				= 0.2
SWEP.Primary.Sound 					= Sound ("w/dc15a_shotgun.wav");
...
SWEP.JumpAccuracyMultiplier			= 1.5
...
SWEP.Primary.Spread					= 0.0959
SWEP.Primary.IronAccuracy 			= 0.0959
...
SWEP.VElements = {
	["dc15a"] = { type = "Model", model = "models/sw_battlefront/weapons/dc15a_rifle.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(0.75, -1.5, 2.5), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 1}},
	["cross"] = { type = "Model", model = "models/sw_battlefront/weapons/2019/dc15s_stock1.mdl", bone = "", rel = "dc15a", pos = Vector(10, 0, 4.5), angle = Angle(0, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}	

SWEP.WElements = {
	["dc15a"] = { type = "Model", model = "models/sw_battlefront/weapons/dc15a_rifle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 0.4, -2), angle = Angle(-13, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 1} },
	["cross"] = { type = "Model", model = "models/sw_battlefront/weapons/2019/dc15s_stock1.mdl", bone = "", rel = "dc15a", pos = Vector(10, 0, 4.5), angle = Angle(0, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}
