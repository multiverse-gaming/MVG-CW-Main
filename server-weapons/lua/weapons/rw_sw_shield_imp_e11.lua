...
SWEP.ViewModelBoneMods = { --
	["v_scoutblaster_reference001"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(-3, 0, 0), angle = Angle(0, 0, 0) }
}

SWEP.VElements = {
	["e11"] = { type = "Model", model = "models/sw_battlefront/weapons/e11_noscope.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(-1, -6, -3), angle = Angle(0, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}
...
function SWEP:SetupShield()
	...
	self.shieldProp:SetModel("models/cs574/weapons/shields/empireshield.mdl");
