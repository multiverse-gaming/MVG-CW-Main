...
SWEP.Primary.Sound 					= Sound ("w/e60r.wav");
...
SWEP.VElements = {
	["rocketlauncher"] = { type = "Model", model = "models/cs574/weapons/e60r.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, -90, 0), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["scope"] = { type = "Model", model = "models/cs574/weapons/e60r_visor.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "rocketlauncher", pos = Vector(0.4, -4.9, 02.95), angle = Angle(-90, -90, 0), size = Vector(0.25, 1, 3), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} },

	["ind"] = { type = "Model", model = "models/cs574/objects/indicateur.mdl", bone = "", rel = "rocketlauncher", pos = Vector(0.85, -5.25, 03.7), angle = Angle(0, -180, 0), size = Vector(1, 1, 1), color = Color(150, 150, 150, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
...
SWEP.WElements = {
	["rocketlauncher"] = { type = "Model", model = "models/cs574/weapons/e60r.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(02, 01, -05.5), angle = Angle(-10, 0, 180), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["scope"] = { type = "Model", model = "models/cs574/weapons/e60r_visor.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "rocketlauncher", pos = Vector(0, -04.8, 03), angle = Angle(0, -90, 0), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} },
...
SWEP.ScopeReticule 					= "cs574/scopes/cgi_hd/sw_redux_cgi_ret_red" 
SWEP.Secondary.ScopeZoom 			= 2
SWEP.ScopeReticule_Scale 			= {0.7,0.7}
if surface then
