...
SWEP.VMPos = Vector(1.83, -5.814, -01.45)
...
SWEP.IronSightsPos = Vector(-6.378, -9.5, 4.25)
...
SWEP.VElements = {
	--["x8"] = { type = "Model", model = "models/strasser/weapons/x8/x8.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(-0.3, -0.8, 0), angle = Angle(0, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["x8"] = { type = "Model", model = "models/hauptmann/star wars/weapons/x8_sniper.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(-0.3, -03.5, -4.5), angle = Angle(0, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_scoutblaster_reference001", rel = "x8", pos = Vector(-2.2, 0.9155, 6.9), angle = Angle(0, 180, 0), size = Vector(0.27, 0.27, 0.27), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	--["x8"] = { type = "Model", model = "models/strasser/weapons/x8/x8.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.5, 1.5, -1.3), angle = Angle(0, -90, 170), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	["x8"] = { type = "Model", model = "models/hauptmann/star wars/weapons/x8_sniper.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(07.3, 01.5, 02), angle = Angle(-10, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
