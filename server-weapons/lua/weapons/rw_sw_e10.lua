...
SWEP.VMPos = Vector(1.97, -02, -1.05)
...
SWEP.IronSightsPos = Vector(-4.925, -8, 4.1)
...
SWEP.VElements = {
	["e11"] = { type = "Model", model = "models/rising/w_e10.mdl", bone = "v_e11_reference001", rel = "", pos = Vector(-2.0+0.01, 9.5, 2.25), angle = Angle(0, 0.65, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[4]=1,[5]=0} },
}

SWEP.WElements = {
	["e11"] = { type = "Model", model = "models/rising/w_e10.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(10.5, 0, -05.2), angle = Angle(0, -90, 169), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[4]=1,[5]=0} }
}
