...
SWEP.PrintName = "CGI Flamethrower"
SWEP.Author = "Fox"
SWEP.Instructions = [[
...
SWEP.ViewModel						= "models/jajoff/sps/cgiweapons/tc13j/btx42.mdl"
SWEP.WorldModel						= "models/jajoff/sps/cgiweapons/tc13j/btx42.mdl"
SWEP.UseHands = true
...
function SWEP:Initialize()
    ...
    if CLIENT then
        ...
        if !IsValid(flamerWeapon) then
            flamerWeapon = ClientsideModel("models/jajoff/sps/cgiweapons/tc13j/btx42.mdl")
