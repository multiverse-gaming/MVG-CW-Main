...
SWEP.CrouchAccuracyMultiplier		= 0.3
SWEP.ChangeStateAccuracyMultiplier	= 0.8
SWEP.JumpAccuracyMultiplier			= 3
...
SWEP.BlowbackVector 				= Vector(0,-1.5,-0.05) --0,-1.5,0
...
SWEP.VMPos = Vector(1.96, 0, -01.52) --1.96, 0, -01.52
...
SWEP.IronSightsPos = Vector(-2.485, -7.5, 3.53) --SWEP.IronSightsPos = Vector(-4.9, -5, 1.5)
...
SWEP.ScopeReticule 					= "cs574/scopes/battlefront_hd/sw_ret_redux_black" --#sw/visor/sw_ret_redux_purple
SWEP.Secondary.ScopeZoom 			= 5 --10
