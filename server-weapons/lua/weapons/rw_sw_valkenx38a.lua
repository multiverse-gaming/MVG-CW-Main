...
SWEP.BlowbackVector 				= Vector(0,-0.45,0)
...
SWEP.IronSightsPos = Vector(-5.1, -8, 2.6075)
...
SWEP.VElements = {
	["valken"] = { type = "Model", model = "models/sw_battlefront/weapons/valken_noscope.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(0.4932, 3, -0.5), angle = Angle(0, 0, -0.3), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}	

SWEP.WElements = {
	["valken"] = { type = "Model", model = "models/sw_battlefront/weapons/valken_noscope.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 0.4, -1.5), angle = Angle(0, -90, 170), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}
