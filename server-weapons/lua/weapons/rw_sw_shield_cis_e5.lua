...
SWEP.PrintName						= "E-5 Shielded"
SWEP.Type							= "CIS Weaponized Shield"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.Primary.IronAccuracy 			= 0.007
...
SWEP.VElements = {
	["dc15s"] = { type = "Model", model = "models/kuro/sw_battlefront/weapons/e5_blaster.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(-0.25, -0.75, -03.95), angle = Angle(0, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },

}

SWEP.WElements = {
	["dc15s"] = { type = "Model", model = "models/kuro/sw_battlefront/weapons/e5_blaster.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(5.5, 1, 2), angle = Angle(-02, -10, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
function SWEP:SetupShield()
	...
	self.shieldProp:SetModel("models/cs574/weapons/shields/droid_shield.mdl");
	...
	self.shieldProp:SetPos(attachTable.Pos + attachTable.Ang:Up()*up + attachTable.Ang:Forward()*forward + attachTable.Ang:Right()*left);
