...
SWEP.PrintName						= "HVER Mk.IV"
SWEP.Type							= "Wolfpack Heavy Marksman Blaster"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.Primary.DefaultClip			= 1*150
SWEP.Primary.RPM					= 90
...
SWEP.ProjectileVelocity 			= 90

SWEP.ProjectileEntity 				= "wp_rocket"
