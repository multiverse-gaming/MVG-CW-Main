...
SWEP.PrintName						= "[AT] DC-17m Riggs"
...
SWEP.Attachments = {
    ...
    [1] = {header = "Modes",atts = {"dc17m_bactagrenade"},},
...
SWEP.AttachmentExclusions = {["dc17m_bactagrenade"]={[3]="dc17m_magext","dc17m_magdrum","dc17m_holosights","raid_grapple"},
...
function SWEP:ShootBullet(...)
	...
	if self:IsAttached("dc17m_bactagrenade") and IsFirstTimePredicted() then

		if SERVER then

			timer.Simple(0, function()

				local ent = ents.Create("bacta_granade_rc") --rw_sw_rc_bacta
