...
SWEP.Primary.DefaultClip			= 40*4
SWEP.Primary.RPM					= 580
...
SWEP.JumpRecoilMultiplier			= 1.4
SWEP.WallRecoilMultiplier			= 1.2
SWEP.ChangeStateRecoilMultiplier	= 1.4
SWEP.CrouchAccuracyMultiplier		= 0.8
SWEP.ChangeStateAccuracyMultiplier	= 1 --1.18
SWEP.JumpAccuracyMultiplier			= 10 --2
...
SWEP.BlowbackVector 				= Vector(0,-3,0)	--Vector(0,-1.5,-0.05)
...
SWEP.Primary.KickDown				= 0.20
SWEP.Primary.KickHorizontal			= 0.055
SWEP.Primary.StaticRecoilFactor 	= 0.5
SWEP.Primary.Spread					= 0.0153--0.00872*0.5*3
SWEP.Primary.IronAccuracy 			= 0.00872*0.5
SWEP.Primary.SpreadMultiplierMax 	= 2.5*4
SWEP.Primary.SpreadIncrement 		= 0.22
SWEP.Primary.SpreadRecovery 		= 0.8*1.65
SWEP.DisableChambering 				= true
SWEP.MoveSpeed 						= 0.95
