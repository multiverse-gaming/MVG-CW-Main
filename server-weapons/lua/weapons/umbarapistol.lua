...
SWEP.UseHands = true
SWEP.Primary.Sound = Sound ("weapons/umbaran/wpn_umbaran_rifle_shoot_02.ogg");
...
SWEP.VElements = {
	...
	["element_name"] = { type = "Model", model = "models/protos/starwars/umbaran/pistol/pistol.mdl", bone = "v_weapon.awm_parent", rel = "", pos = Vector(-3, 3.7, 1), angle = Angle(1, 90, 180), size = Vector(0.899, 0.899, 0.899), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/protos/starwars/umbaran/pistol/pistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(1.7, 4.5, 4), angle = Angle(-100, 0, 0), size = Vector(0.899, 0.899, 0.899), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.VElements = {
	...
	["element_name"] = { type = "Model", model = "models/protos/starwars/umbaran/pistol/pistol.mdl", bone = "v_weapon.awm_parent", rel = "", pos = Vector(0, 5.5, -1.558), angle = Angle(-90, 90, 0), size = Vector(0.899, 0.899, 0.899), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/protos/starwars/umbaran/pistol/pistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4.675, 1.299, 5.714), angle = Angle(-10.52, -2, 180), size = Vector(0.899, 0.899, 0.899), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
--]]