if CLIENT then
SWEP.WepSelectIcon = surface.GetTextureID( "sprites/bucket_syrgun_red" )
SWEP.DrawWeaponInfoBox = false
SWEP.BounceWeaponIcon = false
killicon.Add( "tf_weapon_syringegun_medic", "hud/dneg_image_syrgun", Color( 255, 255, 255, 255 ) )
killicon.Add( "tf_projectile_syringe", "hud/dneg_image_syrgun", Color( 255, 255, 255, 255 ) )
end
...
self.Weapon:EmitSound( "Weapon_SyringeGun.ClipEmpty" )
...
if SERVER then
local entity = ents.Create( "tf_projectile_syringe" )
