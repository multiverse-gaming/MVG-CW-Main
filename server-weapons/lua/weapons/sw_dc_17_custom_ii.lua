...
SWEP.PrintName						= "DC-17 Custom II"
...
SWEP.VElements = {
	["dc17"] = { type = "Model", model = "models/sw_battlefront/weapons/dc17_blaster.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	...
	["scope4"] = { type = "Model", model = "models/sw_battlefront/weapons/e11_scope.mdl", bone = "", rel = "dc17", pos = Vector(6, 0, -3.7), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false  },
