...
SWEP.IronSightsPos = Vector(-4.275, -9.5, 3.875)
...
SWEP.VElements = {
	["d"] = { type = "Model", model = "models/cs574/weapons/dc92s.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(-0.25, -4, -0.35), angle = Angle(0, 90, 0), size = Vector(0.9, 0.9, 0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_scoutblaster_reference001", rel = "d", pos = Vector(-4, -1.385, 3.21), angle = Angle(0, 180, 0), size = Vector(0.31, 0.31, 0.31), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["d"] = { type = "Model", model = "models/cs574/weapons/dc92s.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(7.5, 01.8, -0.75), angle = Angle(-03, 0, 173), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
