...
if ( CLIENT ) then
	SWEP.PrintName			= "Umbaran Shotgun"			
	SWEP.Author				= "ProtOS"
...
SWEP.VElements = {
	...
	["element_name"] = { type = "Model", model = "models/protos/starwars/umbaran/shotgun/shotgun.mdl", bone = "v_weapon.awm_parent", rel = "", pos = Vector(0, -0.7, 5), angle = Angle(2, 89, 180), size = Vector(0.899, 0.899, 0.899), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/protos/starwars/umbaran/shotgun/shotgun.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4, -0.5, -2), angle = Angle(-100, 0, 0), size = Vector(0.899, 0.899, 0.899), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.VElements = {
	...
	["element_name"] = { type = "Model", model = "models/protos/starwars/umbaran/shotgun/shotgun.mdl", bone = "v_weapon.awm_parent", rel = "", pos = Vector(0, 5.5, -1.558), angle = Angle(-90, 90, 0), size = Vector(0.899, 0.899, 0.899), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/protos/starwars/umbaran/shotgun/shotgun.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4.675, 1.299, 5.714), angle = Angle(-10.52, -2, 180), size = Vector(0.899, 0.899, 0.899), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
--]]