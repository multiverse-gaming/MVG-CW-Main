...
SWEP.Primary.Sound 					= Sound ("w/dc17msniper.wav");
...
SWEP.VElements = {
	...
	["sniper_module"] = { type = "Model", model = "models/cs574/dc17m/dc17m_sniper.mdl", bone = "", rel = "dc17m", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}},
	["sniper_module_hp1"] = { type = "Model", model = "models/squad/sf_plates/sf_plate1x1.mdl", bone = "", rel = "sniper_module", pos = Vector(-0.62, 17.175, 6.8), angle = Angle(90, -90, 0), size = Vector(0.11, 0.11, 0), color = Color(0, 200, 255, 255), surpresslightning = false, material = "cs574/scopes/dc17msniperret", skin = 0, bodygroup = {}},
	["sniper_module_hp2"] = { type = "Model", model = "models/squad/sf_plates/sf_plate1x1.mdl", bone = "", rel = "sniper_module", pos = Vector(-0.62, 08.85, 6.8), angle = Angle(90, -90, 0), size = Vector(0.11, 0.11, 0), color = Color(0, 200, 255, 255), surpresslightning = false, material = "cs574/scopes/dc17msniperret", skin = 0, bodygroup = {}},
	["sniper_module_scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "", rel = "sniper_module_hp2", pos = Vector(0.66, -0.66, 0), angle = Angle(90, 180, 0), size = Vector(0.33, 0.33, 0.33), color = Color(255, 255, 255, 255), surpresslightning = true, material = "!tfa_rtmaterial", skin = 0, bodygroup = {}},
	["sniper_mag"] = { type = "Model", model = "models/cs574/dc17m/dc17m_snipermag.mdl", bone = "", rel = "dc17m", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}},
