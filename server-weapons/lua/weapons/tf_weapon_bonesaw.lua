...
killicon.Add( "tf_weapon_bonesaw", "hud/dneg_image_bonesaw", Color( 255, 255, 255, 255 ) )
end
...
SWEP.Primary.Sound = Sound( "Weapon_Bonesaw.Miss" )
...
self.Owner:EmitSound( "Weapon_Bonesaw.HitFlesh" )
end
if !( tr.Entity:IsNPC() || tr.Entity:IsPlayer() ) then
self.Owner:EmitSound( "Weapon_Bonesaw.HitWorld" )
end
end
end
self.Attack = 0
