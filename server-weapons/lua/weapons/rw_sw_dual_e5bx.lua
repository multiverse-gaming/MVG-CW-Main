...
SWEP.Type							= "CIS Dual BX Blaster Carabine"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.Primary.DefaultClip			= 30*8
SWEP.Primary.RPM					= 320*2*0.8
SWEP.Primary.RPM_Burst				= 320*2*0.8
...
SWEP.VElements = {
	["e5"] = { type = "Model", model = "models/kuro/sw_battlefront/weapons/e5_blaster.mdl", bone = "LeftHand_1stP", rel = "", pos = Vector(4, -1.5, -1), angle = Angle(-4, -2, 90), size = Vector(1, 1, 1), color = Color(125, 125, 125, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["e5+"] = { type = "Model", model = "models/kuro/sw_battlefront/weapons/e5_blaster.mdl", bone = "RightHand_1stP", rel = "", pos = Vector(-4, 1.5, 1), angle = Angle(2, 178, 90), size = Vector(1, 1, 1), color = Color(125, 125, 125, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}


SWEP.WElements = {
	["e5"] = { type = "Model", model = "models/kuro/sw_battlefront/weapons/e5_blaster.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(4, 1.2, -2), angle = Angle(0, -10, 2), size = Vector(1, 1, 1), color = Color(125, 125, 125, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["e5+"] = { type = "Model", model = "models/kuro/sw_battlefront/weapons/e5_blaster.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4, 1.2, 2), angle = Angle(0, -9, 180), size = Vector(1, 1, 1), color = Color(125, 125, 125, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
