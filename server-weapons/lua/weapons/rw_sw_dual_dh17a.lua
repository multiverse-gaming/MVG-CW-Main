...
SWEP.PrintName						= "Dual DH-17a"
SWEP.Type							= "Rebel Dual Blaster Pistol"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.Primary.Sound 					= Sound ("w/dh17.wav");
...
SWEP.VElements = {
	["dc17"] = { type = "Model", model = "models/sw_battlefront/weapons/dh17_noscope.mdl", bone = "LeftHand_1stP", rel = "", pos = Vector(4, -1, -1), angle = Angle(-12, -2, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["dc17+"] = { type = "Model", model = "models/sw_battlefront/weapons/dh17_noscope.mdl", bone = "RightHand_1stP", rel = "", pos = Vector(-4, 1, 1), angle = Angle(8, 178, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}


SWEP.WElements = {
	["dc17"] = { type = "Model", model = "models/sw_battlefront/weapons/dh17_noscope.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(3.7, 1, -1.7), angle = Angle(0, -10, 2), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["dc17+"] = { type = "Model", model = "models/sw_battlefront/weapons/dh17_noscope.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.7, 1, 1.7), angle = Angle(0, -8, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
