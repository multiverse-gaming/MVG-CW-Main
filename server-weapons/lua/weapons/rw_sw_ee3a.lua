...
SWEP.IronSightsPos = Vector( -5.6, -7, 02.55)
...
SWEP.VElements = {
    ["ee3"] = { type = "Model", model = "models/sw_battlefront/weapons/ee3_noscope.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(0, -0.5, -0), angle = Angle(-02, -90, 0), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}
