...
SWEP.PrintName						= "[AT] DC-15A (Security Mk.III)"
...
SWEP.Attachments = {
	[1] = {
		header = "Modes",
		atts = {"dc15le","training_mod","destabilized_mod","stun_mod"},
	},
	[2] = {
		header = "Scopes",
	...
	[3] = {
		header = "Muzzles",
		atts = {"dc15_muzzle1","dc15_muzzle2","dc15_muzzle4","stealth_muzzle"},
	},
	[4] = {
		header = "Magazines",
		atts = {"dc15_mxl"},
...
function SWEP:Think(...)
	...
	if ( self.Primary.ClipSize == 100 ) and SERVER then
