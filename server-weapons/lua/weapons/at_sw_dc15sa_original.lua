...
SWEP.PrintName						= "[AT] DC-15SA (Original)"
...
SWEP.Attachments = {
	[1] = {atts = {"training_mod","stun_mod"},order = 1},
	[2] = {atts = {"dc15sa_holo","dc15_s4"},order = 2},
	[3] = {atts = {"dc15sa_optimized_cell"},order = 3},
}
...
SWEP.AttachmentExclusions = {
	["stun_mod"] = { [3] = "dc15sa_optimized_cell"},
...
SWEP.VElements = {
	...
	["barrel"] = { type = "Model", model = "models/sw_battlefront/weapons/2019/a280cfe_barrel_mod.mdl", bone = "", rel = "dc15sa", pos = Vector(-7, 0, 3), angle = Angle(0, 0, 0), size = Vector(0.5, 0.7, 0.7), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = true},
