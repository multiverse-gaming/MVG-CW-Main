...
SWEP.PrintName						= "[AT] DC-17m (Original)"
...
SWEP.Attachments = {
	[1] = {header = "Modes",atts = {"dc17m_sniper","dc17m_rocket"},},
	[2] = {header = "Laser",atts = {"dc17m_laser"},},
	[3]={header="Barrel",atts={"raid_grapple", "dc17m_compensator" },},

}

SWEP.AttachmentDependencies = {
	["dc17m_snipermagext"] = {"dc17m_sniper", ["type"] = "OR"}
}
