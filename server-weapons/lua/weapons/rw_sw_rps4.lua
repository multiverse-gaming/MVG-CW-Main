...
SWEP.VElements = {
	...
	["ind"] = { type = "Model", model = "models/cs574/objects/indicateur.mdl", bone = "", rel = "rocketlauncher", pos = Vector(11.25, 1.68, 3.11), angle = Angle(0, -180, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["laser"] = { type = "Model", model = "models/sw_battlefront/weapons/2019/a280cfe_laser.mdl", bone = "", rel = "ind", pos = Vector(9.85, -1.55, 0.45), angle = Angle(0, 180, -55), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}},
...
SWEP.WElements = {
	...
	["ind"] = { type = "Model", model = "models/cs574/objects/indicateur.mdl", bone = "", rel = "rocketlauncher", pos = Vector(13.70, 2.2, 3.6), angle = Angle(0, -180, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["laser"] = { type = "Model", model = "models/sw_battlefront/weapons/2019/a280cfe_laser.mdl", bone = "", rel = "ind", pos = Vector(10, -1.435, 0.7), angle = Angle(0, 180, -55), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}},
