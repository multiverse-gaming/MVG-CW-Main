...
SWEP.Type							= "Training Republic Heavy Blaster Rifle"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.VElements = {
	...
	["trd"] = { type = "Model", model = "models/hunter/plates/plate025.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(0.75, 10.25, 5.92), angle = Angle(0, 90, 0), size = Vector(0.1, 0.06, 0.1), color = Color(255, 120, 0, 255), surpresslightning = true, material = "models/debug/debugwhite", skin = 0, bodygroup = {} }
}	
