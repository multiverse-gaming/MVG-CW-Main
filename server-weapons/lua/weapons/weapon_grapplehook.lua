...
if engine.ActiveGamemode() == "terrortown" then
	...
	if SERVER then
		resource.AddFile("materials/bobble/rhook.png")
	end
end


SWEP.Icon = "bobble/rhook.png"
...
SWEP.Purpose = "Left click to shoot your hook, reload or right click to detach."

SWEP.Slot = rhook.Slot-1
SWEP.SlotPos = rhook.SlotPos-1
...
SWEP.VElements = {
	["hook"] = { type = "Model", model = "models/props_junk/meathook001a.mdl", bone = "ValveBiped.bolt", rel = "", pos = Vector(0, 0.8, 6.147), angle = Angle(0, 179.998, -180), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["hook"] = { type = "Model", model = "models/props_junk/meathook001a.mdl", bone = "ValveBiped.Anim_Attachment_RH", rel = "", pos = Vector(-2.942, -2.033, 15.98), angle = Angle(-10.454, 180, 180), size = Vector(0.712, 0.712, 0.712), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
function SWEP:PrimaryAttack()
	...
	if IsValid( self.Hook ) then
		...
		timer.Create("emptyanim"..self:EntIndex(),self:SequenceDuration()+.1,1,function()
...
function SWEP:Reload()
	...
	if not self.CanShoot then
		...
		timer.Remove("emptyanim"..self:EntIndex())
...
SWEP.SecondaryAttack = SWEP.Reload
