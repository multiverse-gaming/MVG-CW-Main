...
SWEP.Author							= "ChanceSphere574 | Modified by Fox"
SWEP.Contact						= ""
SWEP.Spawnable						= true
SWEP.AdminSpawnable					= true
SWEP.DrawCrosshair					= true
SWEP.DrawCrosshairIS 				= false
SWEP.PrintName						= "[AT] DC-17m (Plank)"
...
SWEP.Primary.DefaultClip			= 20*200
...
SWEP.Primary.IronAccuracy 			= 0.0010
...
SWEP.Attachments = {[1]={header="Modes",atts={"dc17m_sniper_healing"},},
										[2]={header="Holosights",atts = {"dc17m_holosights"},},
										[3]={header="Laser",atts = {"dc17m_laser"},},
										[4]={header="Barrel",atts={"raid_grapple", "dc17m_compensator" },},
									}
SWEP.AttachmentDependencies = {["dc17m_snipermagext"] = {"dc17m_sniper", ["type"] = "OR"}}

SWEP.AttachmentExclusions = {["dc17m_sniper_lite"]={[3]="dc17m_magext","dc17m_magdrum","dc17m_holosights"},
							["dc17m_sniper_healing"]={[3]="dc17m_magext","dc17m_magdrum","dc17m_holosights"},
...
SWEP.VElements = {
	...
	["rifle_module"] = { type = "Model", model = "models/cs574/dc17m/dc17m_rifle.mdl", bone = "", rel = "dc17m", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false  },
	...
	["sniper_module"] = { type = "Model", model = "models/cs574/dc17m/dc17m_sniper.mdl", bone = "", rel = "dc17m", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = true  },
	...
	["sniper_module_scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "", rel = "sniper_module_hp2", pos = Vector(0.66, -0.66, 0), angle = Angle(90, 180, 0), size = Vector(0.33, 0.33, 0.33), color = Color(255, 255, 255, 255), surpresslightning = true, material = "!tfa_rtmaterial", skin = 0, bodygroup = {}, active = true  },
	...
	["sniper_magext"] = { type = "Model", model = "models/cs574/dc17m/dc17m_snipermagext.mdl", bone = "", rel = "dc17m", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = true  },

	["dc17m_ironsight"] = { type = "Model", model = "models/cs574/dc17m/dc17m_ironsight.mdl", bone = "", rel = "dc17m", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false  },
...
SWEP.CustomBulletCallback = function( ply, tr, dmg )
    ...
    local heal = 100
    local degen = 5
    if (tr.Entity:IsPlayer() and dmg:GetDamage() <= 10.0 ) then

        tr.Entity:EmitSound( "items/smallmedkit1.wav" )
        if (tr.Entity:Health() >= tr.Entity:GetMaxHealth()) then -- HEALTH IS EITHER STIMMED OR SET, SO DONT SET

        elseif(tr.Entity:Health() + heal < tr.Entity:GetMaxHealth()) then
            tr.Entity:SetHealth(tr.Entity:Health() + heal)
        else
            tr.Entity:SetHealth( math.Clamp( tr.Entity:Health() + heal, 0, tr.Entity:GetMaxHealth() ) )
        end
