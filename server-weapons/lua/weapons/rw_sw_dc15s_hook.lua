...
SWEP.VElements = {
	...
	["dc15s_grapple_att"] = { type = "Model", model = "models/stein/dc15s_att_grapple.mdl", bone = "", rel = "dc15s", pos = Vector(18, 0, 2.4), angle = Angle(0, 0, 0), size = Vector(1.69, 1.69, 1.69), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["grapple_hook"] = { type = "Model", model = "models/stein/hook.mdl", bone = "", rel = "dc15s_grapple_att", pos = Vector(4,0,-3.9), angle = Angle(-90,0,0), size = Vector(0.3,0.3,0.3), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = true  },
...
SWEP.WElements = {
	...
	["dc15s_grapple_att"] = { type = "Model", model = "models/stein/dc15s_att_grapple.mdl", bone = "", rel = "dc15s", pos = Vector(14.5, 0, 1.8), angle = Angle(0, 0, 0), size = Vector(1.3, 1.3, 1.3), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["grapple_hook"] = { type = "Model", model = "models/stein/hook.mdl", bone = "", rel = "dc15s_grapple_att", pos = Vector(4,0,-2.9), angle = Angle(-90,0,0), size = Vector(0.3,0.3,0.3), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = true  },
