...
SWEP.PrintName						= "Dual RK-3"
SWEP.Type							= "Imperial Dual Blaster Pistol"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.VElements = {
	["rk3"] = { type = "Model", model = "models/markus/fo_rk3_blaster_pistol/fo_rk3_blaster_pistol.mdl", bone = "LeftHand_1stP", rel = "", pos = Vector(3.5, 2.2, -1.2), angle = Angle(-98, -2, 90), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["rk3+"] = { type = "Model", model = "models/markus/fo_rk3_blaster_pistol/fo_rk3_blaster_pistol.mdl", bone = "RightHand_1stP", rel = "", pos = Vector(-3.5, -2.2, 1.2), angle = Angle(-90, 178, 90), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}


SWEP.WElements = {
	["rk3"] = { type = "Model", model = "models/markus/fo_rk3_blaster_pistol/fo_rk3_blaster_pistol.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(4, 1, 1.5), angle = Angle(0, -100, 2), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["rk3+"] = { type = "Model", model = "models/markus/fo_rk3_blaster_pistol/fo_rk3_blaster_pistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4.5, 1, -1.5), angle = Angle(0, 88, 180), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
