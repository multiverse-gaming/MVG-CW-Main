...
SWEP.PrintName						= "[AT] DC-17m Shotgun"
...
SWEP.Attachments = {
	[1]={header="Modes",atts={"dc17m_shotgun_special"},},
  [2] = {header = "Mags",atts = {"dc17m_magext"},},
...
SWEP.AttachmentExclusions = {["dc17m_shotgun_special"]={[3]="dc17m_magext","dc17m_magdrum","dc17m_holosights"},
