...
SWEP.PrintName						= "MiniMag-PLT"
SWEP.Type							= "Imperial Rocket Launcher (waiting a new model for update it)"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.IronSightsPos = Vector(-3.3, -1, -0.5)
SWEP.IronSightsAng = Vector(0, 0, 0)

SWEP.RunSightsPos = Vector(0.0, 0, 0)
...
SWEP.VElements = {
	["rocketlauncher"] = { type = "Model", model = "models/weapons/star_wars_battlefront/imp_rocket_launcher.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(0, 10, 0), angle = Angle(0, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "", rel = "rocketlauncher", pos = Vector(-7.58, 10.6, 3.2), angle = Angle(180, 90, 180), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = true, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["rocketlauncher"] = { type = "Model", model = "models/weapons/star_wars_battlefront/imp_rocket_launcher.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(7.5, 1, -4.5), angle = Angle(0, 90, 192), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.ScopeReticule 					= "cs574/scopes/cgi_hd/sw_redux_cgi_ret_blue" 
