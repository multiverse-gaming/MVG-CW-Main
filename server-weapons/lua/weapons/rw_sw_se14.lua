...
SWEP.VMPos = Vector(1.240, -6.819, -01.085)
...
SWEP.IronSightsPos = Vector(-5.2, -3, 2.1)
...
SWEP.VElements = {
    ["se14"] = { type = "Model", model = "models/sw_battlefront/weapons/2019/se14_pistol.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(0, 0, -3.5), angle = Angle(0, 90, 0), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["se14"] = { type = "Model", model = "models/sw_battlefront/weapons/2019/se14_pistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4, 1.5, 1.5), angle = Angle(-8, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
