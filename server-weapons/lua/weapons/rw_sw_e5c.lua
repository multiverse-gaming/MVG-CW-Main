...
SWEP.Primary.Sound 					= Sound ("w/e5c.wav");
...
SWEP.VElements = {
	["e5c"] = { type = "Model", model = "models/kuro/sw_battlefront/weapons/e5c_blaster.mdl", bone = "v_t21_reference001", rel = "", pos = Vector(0.699, 3.5, -2.8), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["e5c"] = { type = "Model", model = "models/kuro/sw_battlefront/weapons/e5c_blaster.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4.5, 1, 3.5), angle = Angle(-8, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
