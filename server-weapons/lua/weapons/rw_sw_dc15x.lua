...
SWEP.IronSightsPos = Vector(-3.88, -9, 2.825)
...
SWEP.WElements = {
	["dc15x"] = { type = "Model", model = "models/cs574/weapons/dc15x.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 0.4, -2), angle = Angle(-13, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 0, [2] = 0, [3] = 1} },
}
