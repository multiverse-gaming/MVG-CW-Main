...
SWEP.PrintName						= "DH-17 Shielded"
SWEP.Type							= "Rebel Weaponized Shield"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.VElements = {
	["dc17"] = { type = "Model", model = "models/sw_battlefront/weapons/dh17_noscope.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(-0.5, -0.5, -02.75), angle = Angle(0, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["dc17"] = { type = "Model", model = "models/sw_battlefront/weapons/dh17_noscope.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4, 1.2, 1.5), angle = Angle(-07, -10, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}
...
function SWEP:SetupShield()
	...
	self.shieldProp:SetModel("models/cs574/weapons/shields/rebel_shield.mdl");
