...
SWEP.Manufacturer 					= ""
SWEP.Author							= "ChanceSphere574 | Edited by Fox"
SWEP.Contact						= ""
SWEP.Spawnable						= true
SWEP.AdminSpawnable					= true
SWEP.DrawCrosshair					= true
SWEP.DrawCrosshairIS 				= false
SWEP.PrintName						= "DC-15a Shotgun III"
SWEP.Type							= "Customisable Republic Heavy Blaster Rifle inc Shotgun mode"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.Primary.DefaultClip			= 40*20
SWEP.Primary.RPM					= 600
SWEP.Primary.RPM_Burst				= 600*3.5
...
SWEP.Primary.Spread					= 0.01000
SWEP.Primary.IronAccuracy 			= 0.00872
SWEP.Primary.SpreadMultiplierMax 	= 1.5
SWEP.Primary.SpreadIncrement 		= 0.45
...
SWEP.AttachmentDependencies = {["hv_attachment"] = {"shotgun_mode", ["type"] = "AND"}}

SWEP.AttachmentExclusions = {
	["shotgun_mode"] = {"dc15_s3","dc15_s4","dc15_s7","dc15_s8","dc15_mxl","dc15_bipod_on",},
}

SWEP.VElements = {
	["hv_attachment"] = { type = "Model", model = "models/sw_battlefront/weapons/2019/tl50_cellmod.mdl", bone = "", rel = "dc15", pos = Vector(6, 1, -2), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false  },
