...
SWEP.PrintName				= "Energy staff Recon"
SWEP.Author					= "Drugz"

SWEP.Purpose				= "A quick moving flux stream blade. Not the strongest, but surely the fastest."
SWEP.Instructions			= "Mouse1 to strike, Mouse2 to teleport."

SWEP.Slot					= 0
SWEP.SlotPos				= 4

SWEP.ViewModel = "models/weapons/c_stunstick.mdl"
SWEP.WorldModel = "models/tfa/comm/gg/prp_magna_guard_weapon_season4.mdl"
...
SWEP.VElements = {
	["FX1"] = { type = "Sprite", sprite = "particle/particle_glow_04", bone = "ValveBiped.Bip01_R_Hand", rel = "Staff", pos = Vector(-18.701, 0, 0), angle = Angle(0, 0, 0), size = { x = 4, y = 4 }, color = Color(185, 0, 255, 255), nocull = true, additive = true, vertexalpha = true, vertexcolor = true, ignorez = true},
	["FX1++"] = { type = "Sprite", sprite = "particle/particle_glow_04", bone = "ValveBiped.Bip01_R_Hand", rel = "FX1", pos = Vector(-1.558, 0, 0), angle = Angle(0, 0, 0), size = { x = 4, y = 4 }, color = Color(185, 0, 255, 255), nocull = true, additive = true, vertexalpha = true, vertexcolor = true, ignorez = true},
	["FX1+++"] = { type = "Sprite", sprite = "particle/particle_glow_04", bone = "ValveBiped.Bip01_R_Hand", rel = "FX1", pos = Vector(-3.636, 0, 0), angle = Angle(0, 0, 0), size = { x = 4, y = 4 }, color = Color(185, 0, 255, 255), nocull = true, additive = true, vertexalpha = true, vertexcolor = true, ignorez = true},
	["FX1+"] = { type = "Sprite", sprite = "particle/particle_glow_04", bone = "ValveBiped.Bip01_R_Hand", rel = "FX1", pos = Vector(-5.2, 0, 0, 0), angle = Angle(0, 0, 0), size = { x = 4, y = 4 }, color = Color(185, 0, 255, 255), nocull = true, additive = true, vertexalpha = true, vertexcolor = true, ignorez = true},
	["Staff"] = { type = "Model", model = "models/tfa/comm/gg/prp_magna_guard_weapon_season4.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-6.753, 1.557, -9.87), angle = Angle(80, 68.96, -31.559), size = Vector(0.625, 0.625, 0.625), color = Color(150, 150, 150, 255), surpresslightning = true, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.WElements = {
	...
	["FX"] = { type = "Sprite", sprite = "particle/particle_glow_04", bone = "ValveBiped.Bip01_R_Hand", rel = "Staff", pos = Vector(-32.728, 0, 0), size = { x = 5.816, y = 5.816 }, color = Color(185, 0, 255, 255), nocull = true, additive = true, vertexalpha = true, vertexcolor = true, ignorez = false},
	...
	["FX+"] = { type = "Sprite", sprite = "particle/particle_glow_04", bone = "ValveBiped.Bip01_R_Hand", rel = "Staff", pos = Vector(-24.417, 0, 0), size = { x = 5.816, y = 5.816 }, color = Color(185, 0, 255, 255), nocull = true, additive = true, vertexalpha = true, vertexcolor = true, ignorez = false},
	...
	["FX++++++++"] = { type = "Sprite", sprite = "particle/particle_glow_04", bone = "ValveBiped.Bip01_R_Hand", rel = "Staff", pos = Vector(29.61, 0, 0), size = { x = 5.816, y = 5.816 }, color = Color(185, 0, 255, 255), nocull = true, additive = true, vertexalpha = true, vertexcolor = true, ignorez = false},
	...
	["FX++++"] = { type = "Sprite", sprite = "particle/particle_glow_04", bone = "ValveBiped.Bip01_R_Hand", rel = "Staff", pos = Vector(-30.65, 0, 0), size = { x = 5.816, y = 5.816 }, color = Color(185, 0, 255, 255), nocull = true, additive = true, vertexalpha = true, vertexcolor = true, ignorez = false},
	...
	["FX+++++++"] = { type = "Sprite", sprite = "particle/particle_glow_04", bone = "ValveBiped.Bip01_R_Hand", rel = "Staff", pos = Vector(27.531, 0, 0), size = { x = 5.816, y = 5.816 }, color = Color(185, 0, 255, 255), nocull = true, additive = true, vertexalpha = true, vertexcolor = true, ignorez = false},
	["FX++++++"] = { type = "Sprite", sprite = "particle/particle_glow_04", bone = "ValveBiped.Bip01_R_Hand", rel = "Staff", pos = Vector(24.416, 0, 0), size = { x = 5.816, y = 5.816 }, color = Color(185, 0, 255, 255), nocull = true, additive = true, vertexalpha = true, vertexcolor = true, ignorez = false},
	...
	["FX+++++++++"] = { type = "Sprite", sprite = "particle/particle_glow_04", bone = "ValveBiped.Bip01_R_Hand", rel = "Staff", pos = Vector(32.727, 0, 0), size = { x = 5.816, y = 5.816 }, color = Color(185, 0, 255, 255), nocull = true, additive = true, vertexalpha = true, vertexcolor = true, ignorez = false},
	["FX+++"] = { type = "Sprite", sprite = "particle/particle_glow_04", bone = "ValveBiped.Bip01_R_Hand", rel = "Staff", pos = Vector(-28.571, 0, 0), size = { x = 5.816, y = 5.816 }, color = Color(185, 0, 255, 255), nocull = true, additive = true, vertexalpha = true, vertexcolor = true, ignorez = false},
	["FX++"] = { type = "Sprite", sprite = "particle/particle_glow_04", bone = "ValveBiped.Bip01_R_Hand", rel = "Staff", pos = Vector(-26.494, 0, 0), size = { x = 5.816, y = 5.816 }, color = Color(185, 0, 255, 255), nocull = true, additive = true, vertexalpha = true, vertexcolor = true, ignorez = false}
}

--resource.AddSingleFile( "weapons/eblade/eblade_idle.wav" )

local SwingElectric = {"weapons/miss.wav" }
...
local HitDefault = Sound( "common/bass.wav" )
local comfort = 0
...
function SWEP:Think()
	...
	if ( IsExistent( self ) ) and ( IsExistent( self:GetNWEntity( "blade" ) ) ) then
		...
		if ( self:GetNWBool( "eblade_active" ) == true ) and SERVER then
...
function SWEP:Deploy()
	...
	self.Weapon:SetHoldType( "electrorecon" )
...
function SWEP:PrimaryAttack()
	...
	local weaken = 0.05 + ( self.SciFiACC / 45 )

	self:UpdateNextIdle()
	self:SetNextMeleeAttack( CurTime() + 0.065 )
...
--	local anim = self:GetSequenceName( self.Owner:GetViewModel():GetSequence() )
	...
	local velo = math.Clamp( ( math.Round( ( math.abs( playervelo.y ) + math.abs( playervelo.x ) + math.abs( playervelo.z ) ) ) / 128 ), 1, 10 )
	...
	if ( tr.Hit && !( game.SinglePlayer() && CLIENT ) ) then
		...
		if ( anim == "stab" ) then
			ParticleEffect( "hpw_stupefy_impactbody", tr.HitPos, self.Owner:EyeAngles(), self )
		else
			ParticleEffect( "hpw_stupefy_impactbody", tr.HitPos, self.Owner:EyeAngles(), self )
		end
