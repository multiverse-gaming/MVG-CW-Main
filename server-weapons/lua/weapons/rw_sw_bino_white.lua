...
SWEP.PrintName						= "Binoculars (White)"
SWEP.Type							= "StarWars White Binoculars"
SWEP.DrawAmmo						= false
SWEP.data 							= {}
...
SWEP.VElements = {
	["bino"] = { type = "Model", model = "models/nate159/swbf2015/pewpew/electrobinocular.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(-5, 2, 0), angle = Angle(0, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "anthonyfuller/macrobinoculars/t_electrobinocularstd23_c_white", skin = 0, bodygroup = {} },
