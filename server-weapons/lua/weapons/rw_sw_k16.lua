...
SWEP.VElements = {
	["k16"] = { type = "Model", model = "models/hauptmann/star wars/weapons/bryar_pistol.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(-0, -05, -05.3), angle = Angle(0, 90, 0), size = Vector(1.05, 1.05, 1.05), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["k16"] = { type = "Model", model = "models/hauptmann/star wars/weapons/bryar_pistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(8.3, 1.75, 3.25), angle = Angle(0, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
