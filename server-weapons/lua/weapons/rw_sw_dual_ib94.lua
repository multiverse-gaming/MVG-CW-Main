...
SWEP.PrintName						= "Dual IB-94"
SWEP.Type							= "Galactic Dual Heavy Blaster Pistol"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.Primary.RPM					= 180*2*0.8
SWEP.Primary.RPM_Burst				= 180*2*0.8
...
SWEP.VElements = {
	["rk3"] = { type = "Model", model = "models/cs574/weapons/dc92.mdl", bone = "LeftHand_1stP", rel = "", pos = Vector(8, 01.25, -1.6), angle = Angle(-10, 0, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["rk3+"] = { type = "Model", model = "models/cs574/weapons/dc92.mdl", bone = "RightHand_1stP", rel = "", pos = Vector(-8, -01.25, 1.6), angle = Angle(170, 0, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}


SWEP.WElements = {
	["rk3"] = { type = "Model", model = "models/cs574/weapons/dc92.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(7.75, 01.75, 0.5), angle = Angle(0, -10, 2), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["rk3+"] = { type = "Model", model = "models/cs574/weapons/dc92.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(7.75, 01.75, -0.5), angle = Angle(0, -10, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
