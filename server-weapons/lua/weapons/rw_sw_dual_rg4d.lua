...
SWEP.Type							= "CIS Dual Blaster Pistol"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.VElements = {
	["rg4d"] = { type = "Model", model = "models/kuro/sw_battlefront/weapons/rg4d_blaster.mdl", bone = "LeftHand_1stP", rel = "", pos = Vector(7.5, -0.5, -1), angle = Angle(-5, -2, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["rg4d+"] = { type = "Model", model = "models/kuro/sw_battlefront/weapons/rg4d_blaster.mdl", bone = "RightHand_1stP", rel = "", pos = Vector(-7.5, 0.5, 1), angle = Angle(0, 178, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}


SWEP.WElements = {
	["rg4d"] = { type = "Model", model = "models/kuro/sw_battlefront/weapons/rg4d_blaster.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(7.5, 1.5, -1.5), angle = Angle(-6, 0, 2), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["rg4d+"] = { type = "Model", model = "models/kuro/sw_battlefront/weapons/rg4d_blaster.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(7.5, 1.5, 1.5), angle = Angle(0, -2, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
