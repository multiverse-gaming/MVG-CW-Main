...
SWEP.PrintName						= "[AT] DC-17m Railgun"
...
SWEP.Attachments = {[1]={header="Modes",atts={"dc17m_railgun"},},
                    [2]={header="Barrel",atts={"raid_grapple", "dc17m_compensator" },},
}
...
SWEP.VElements = {
	...
	["dc17m_holosight_holo"] = { type = "Model", model = "models/squad/sf_plates/sf_plate1x1.mdl", bone = "", rel = "dc17m_holosight", pos = Vector(1.199, 0.5, 5.245), angle = Angle(90, 90, 0), size = Vector(0.2, 0.2, 0.0), color = Color(255, 255, 255, 255), surpresslightning = false, material = "cs574/scopes/dc17mret", skin = 0, bodygroup = {}, active = false  },
...
function SWEP:Deploy()
	...
	hook.Add("SetupMove", "Disable Reload ON DC-17m RailGun if using", function(ply, mvd, cmd)
		if mvd:KeyDown(IN_RELOAD) and ply:GetActiveWeapon():GetClass() == "at_sw_dc17m_railgun" and ply:GetActiveWeapon():IsAttached("dc17m_railgun") then
