...
SWEP.PrintName						= "Light WristBlaster White"
...
SWEP.MuzzleFlashEffect 				= "rw_sw_muzzleflash_white"
...
SWEP.VElements = {
	...
	["blaster"] = { type = "Model", model = "models/sw_battlefront/weapons/2019/a280cfe_defaultbarrel.mdl", bone = "", rel = "base", pos = Vector(-17.2, -0.25, 04.15), angle = Angle(-03.5, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["blaster2"] = { type = "Model", model = "models/sw_battlefront/weapons/mods/blurrg_cycler_default.mdl", bone = "", rel = "blaster", pos = Vector(15.25, 0, -01.9), angle = Angle(0, 90, 0), size = Vector(1.55, 1.55, 1.55), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}
...
SWEP.WElements = {
	...
	["blaster2"] = { type = "Model", model = "models/sw_battlefront/weapons/mods/blurrg_cycler_default.mdl", bone = "ValveBiped.Bip01_R_Wrist", rel = "blaster", pos = Vector(15.25, 0, -01.9), angle = Angle(0, 90, 0), size = Vector(1.55, 1.55, 1.55), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}
