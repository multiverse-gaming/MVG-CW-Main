...
SWEP.PrintName						= "Dual E-11"
SWEP.Type							= "Imperial Dual Blaster Carabine"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.Primary.RPM					= 300*2*0.8
SWEP.Primary.RPM_Burst				= 300*2*0.8
...
SWEP.VElements = {
	["dc15s"] = { type = "Model", model = "models/sw_battlefront/weapons/e11_noscope.mdl", bone = "LeftHand_1stP", rel = "", pos = Vector(9, -1.2, -1.5), angle = Angle(-6, -2, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["dc15s+"] = { type = "Model", model = "models/sw_battlefront/weapons/e11_noscope.mdl", bone = "RightHand_1stP", rel = "", pos = Vector(-9, 1.2, 1.5), angle = Angle(2, 178, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}


SWEP.WElements = {
	["dc15s"] = { type = "Model", model = "models/sw_battlefront/weapons/e11_noscope.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(7.5, 1.7, -1.75), angle = Angle(0, -10, 2), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["dc15s+"] = { type = "Model", model = "models/sw_battlefront/weapons/e11_noscope.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(7.5, 1.7, 1.75), angle = Angle(0, -1, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
