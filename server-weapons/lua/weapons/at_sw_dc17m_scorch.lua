-- IF YOU UPDATE THERE PRINT NAMES UPDATE dc-17m rocket modules

SWEP.Gun							= ("at_sw_dc17m_scorch")
...
SWEP.PrintName						= "[AT] DC-17m Scorch"
...
SWEP.Attachments = {
	...
	[1] = {header = "Modes",atts = {"dc17m_rocket"},},

    [2] = {header = "Holosights",atts = {"dc17m_holosights"},},

    [3] = {header = "Mags",atts = {"dc17m_magdrum", "dc17m_magext"},},
	...
	[5]={header="Barrel",atts={"raid_grapple", "dc17m_tripod", "dc17m_compensator" },},

}

--[[SWEP.AttachmentDependencies = {["dc17m_snipermagext"] = {"dc17m_sniper", ["type"] = "OR"}}--]]

SWEP.AttachmentExclusions = {["dc17m_sniper"]={[3]="dc17m_magext","dc17m_magdrum","dc17m_holosights"},
								["dc17m_rocket"]={[3]="dc17m_magext","dc17m_magdrum","raid_grapple"},
...
SWEP.VElements = {
	...
	["antiarmour_module"] = { type = "Model", model = "models/cs574/dc17m/dc17m_rocket.mdl", bone = "", rel = "dc17m", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false  },
