...
SWEP.VMPos = Vector(1.248, -3.819, -01.168)
...
SWEP.IronSightsPos = Vector(-5.2, -4, 01.65)
...
SWEP.VElements = {
    ["se14c"] = { type = "Model", model = "models/kuro/sw_battlefront/weapons/bf1/se14c.mdl", bone = "v_scoutblaster_reference001", rel = "", pos = Vector(0, 0, -3.5), angle = Angle(0, 90, 0), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/weapons/synbf3/w_models/se14c/t_se14c_c", skin = 0, bodygroup = {} },
	["scope1"] = { type = "Model", model = "models/rtcircle.mdl", bone = "", rel = "se14c", pos = Vector(-9.09, 0, 8.21), angle = Angle(0, 180, 0), size = Vector(0.22, 0.22, 0.22), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} },
	["scope2"] = { type = "Model", model = "models/rtcircle.mdl", bone = "", rel = "se14c", pos = Vector(-8.9, 1.81, 7.03), angle = Angle(0, 180, 0), size = Vector(0.22, 0.22, 0.22), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["se14c"] = { type = "Model", model = "models/kuro/sw_battlefront/weapons/bf1/se14c.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4, 1.5, 1.5), angle = Angle(-8, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "models/weapons/synbf3/w_models/se14c/t_se14c_c", skin = 0, bodygroup = {} }
}
