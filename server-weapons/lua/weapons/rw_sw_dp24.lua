...
SWEP.CrouchAccuracyMultiplier		= 0.5 --0.8
SWEP.ChangeStateAccuracyMultiplier	= 1.18 --1
SWEP.JumpAccuracyMultiplier			= 5 --10
...
SWEP.Primary.KickHorizontal			= 0.06
SWEP.Primary.StaticRecoilFactor 	= 0.6
SWEP.Primary.Spread					= 0.02 --0.03
SWEP.Primary.IronAccuracy 			= 0.0055
SWEP.Primary.SpreadMultiplierMax 	= 1.5 --2.3
...
--[[SWEP.IronSightsPos = Vector(-4.85, -8, 5.3)
...
--	["e11"] = { type = "Model", model = "e11d model here", bone = "v_e11_reference001", rel = "", pos = Vector(-2.0+0.01, 9.5, 2.25), angle = Angle(0, 0.65, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[4]=1,[5]=0} },

--	["dc15s"] = { type = "Model", model = "models/cs574/weapons/dp24.mdl", bone = "v_e11_reference001", rel = "", pos = Vector(-0.9, 3, 0), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }, }
...
--	["e11"] = { type = "Model", model = "e11d model here", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(10.5, 0, -05.2), angle = Angle(0, -90, 169), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[4]=1,[5]=0} }
}

--	["dc15s"] = { type = "Model", model = "models/cs574/weapons/dp24.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.5, 0.5, -1.25), angle = Angle(-13, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} } }
