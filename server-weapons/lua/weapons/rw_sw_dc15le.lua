...
SWEP.Primary.Spread					= 0.0261 --was 0.012
...
SWEP.IronSightsPos = Vector(-5.965, -7.5, 4.265)
...
SWEP.VElements = {
	["dc15le"] = { type = "Model", model = "models/sw_battlefront/weapons/dc15a_rifle.mdl", bone = "v_dlt19_reference001", rel = "", pos = Vector(0.75, -1.5, 2.5), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 1, [2] = 1, [3] = 0} },
...
SWEP.WElements = {
	["dc15le"] = { type = "Model", model = "models/sw_battlefront/weapons/dc15a_rifle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 0.4, -2), angle = Angle(-13, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 1, [2] = 1, [3] = 0} },
}

-- From sw_dc_17_custom_i.lua
SWEP.Attachments = {
	[1] = {
		header = "Modes",
		atts = {"rw_rep_mod_stun5"},
	},
}
...
function SWEP:Think(...)
	...
	if self:IsAttached("rw_rep_mod_stun5") then
		if SERVER then
			if ( self.Weapon:Clip1() <= self.Primary.ClipSize - 6 ) then
