...
if ( CLIENT ) then
	SWEP.PrintName			= "212th Vibro Knife"
	SWEP.DrawAmmo 			= false
...
SWEP.ViewModel 			= "models/weapons/212th_knife/212th_knife_t.mdl"
SWEP.WorldModel 		= "models/weapons/212th_knife/212th_knife_v.mdl" 
