...
att.SortOrder = 100
att.Icon = nil
att.Description = "Extended magazine, slightly larger allowing to hold much more Tibanna, only downside is being heavier causing a slower reload"
att.Desc_Pros = {}
att.Desc_Cons = {}

att.Desc_Neutrals = {}
att.Slot = "dc17m_magazine"
