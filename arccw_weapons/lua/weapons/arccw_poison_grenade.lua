...
SWEP.IconOverride = "materials/entities/rw_sw_nade_dioxis.png"
...
SWEP.ShootEntity = "arccw_thr_poison"

SWEP.PullPinTime = 0.5

SWEP.ViewModelFOV = 70

SWEP.DefaultElements = {"dioxis_grenade"}
...
WMOverride = "models/cs574/explosif/grenade_dioxis.mdl" -- change the world model to something else. Please make sure it's compatible with the last one.
