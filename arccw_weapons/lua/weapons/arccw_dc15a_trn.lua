...
SWEP.AttachmentElements = {
    ["dc15a"] = {
        ...
        WMOverride = "models/arccw/sw_battlefront/weapons/new/dc15a_rifle.mdl", -- change the world model to something else. Please make sure it's compatible with the last one.
    },
}
