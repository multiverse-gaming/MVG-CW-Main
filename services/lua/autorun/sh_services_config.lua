...
local function CreateConfig()
		...
		CONFIG_SERVICES.Settings = {
			...
			["212th"] = {Teams = {TEAM_212THGENERAL, TEAM_212THMCOMMANDER, TEAM_212THCOMMANDER, TEAM_212THEXECUTIVEOFFICER, TEAM_212THMAJOR, TEAM_212THLIEUTENANT, TEAM_212THHEAVYTROOPER, TEAM_ARCALPHA212th, TEAM_212THARC, TEAM_212THMEDOFFICER, TEAM_212THSERGEANT, TEAM_212THMEDTROOPER, TEAM_WPGENERALPLO, TEAM_212THJEDI, TEAM_212THGENERALOBI, TEAM_212THTROOPER,}, Description = "Request assistance from the 212th.", icon = "materials/services_revamp/212th.png", price = 0, CustomCheck = function(ply) return true end, FailMessage = "You failed the custom check!", colorCustom = Color(255, 157, 0, 255), plyOnline = 0}
		}
