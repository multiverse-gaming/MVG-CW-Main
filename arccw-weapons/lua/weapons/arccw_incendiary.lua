...
SWEP.IconOverride = "materials/entities/rw_sw_nade_incendiary.png"
...
SWEP.ShootEntity = "arccw_thr_incendiary"

SWEP.PullPinTime = 0.5

SWEP.ViewModelFOV = 70

SWEP.DefaultElements = {"incendiary_grenade"}
...
WMOverride = "models/weapons/tfa_starwars/w_incendiary.mdl" -- change the world model to something else. Please make sure it's compatible with the last one.
