...
SWEP.Trivia_Class = "Marksman Blaster"
SWEP.Trivia_Desc = "High tech long-range blaster rifle."
...
SWEP.DefaultElements = {"dc15x", "muzzle"}

SWEP.AttachmentElements = {
    ["dc15x"] = {
        VMElements = {
            {
                Model = "models/arccw/cs574/weapons/dc15x_nobipod.mdl",
...
WMOverride = "models/arccw/cs574/weapons/dc15x_nobipod.mdl" -- change the world model to something else. Please make sure it's compatible with the last one.
--SWEP.Attachments 
...
SWEP.Attachments = {
    [1] = {
        ...
        Offset = {
            vpos = Vector(0.23, -0.7, 9),
            vang = Angle(90, 0, -90),
            wpos = Vector(1400, 0, -830),
            wang = Angle(-15, 0, 180)
        },
    }
--[[    [2] = {
        ...
        WMScale = Vector(111, 111, 111),
        Bone = "v_dlt19_reference001", -- relevant bone any attachments will be mostly referring to
        Offset = {
            vpos = Vector(0.7, 30, 4),
            vang = Angle(-180, -90, 0),
            wpos = Vector(4000, 120, -1300),
            wang = Angle(-15, 0, -90)
        },
    }, 
    [3] = {
        ...
        Offset = {
            vpos = Vector(-0.2, 2.5, 16),
            vang = Angle(90, 0, -90),
        },
        SlideAmount = {
        vmin = Vector(-0.2, 2.5, 16),
        vmax = Vector(-0.2, 2.5, 19), -- how far this attachment can slide in both directions.
        },
        NoWM = true,
    },
    [4] = {
        ...
        Bone = "dlt19_sight", -- relevant bone any attachments will be mostly referring to
        Offset = {
            vpos = Vector(0.3, 1.7, 42.5),
            vang = Angle(90, 0, -90),
            wpos = Vector(5000, 0, -1570),
            wang = Angle(-15, 0, -90)
        },
    },           
    [5] = {
