...
SWEP.AccuracyMOA = 1.10 -- accuracy in Minutes of Angle. There are 60 MOA in a degree.
...
SWEP.ShootSound = "w/dc17msniper.wav"
...
SWEP.DefaultElements = {"dc17ms", "muzzle"}

SWEP.AttachmentElements = {
    ["dc17ms"] = {
        VMElements = {
            {
                Model = "models/arccw/sauce/dc17m_sniper.mdl",
...
WMOverride = "models/arccw/sauce/dc17m_sniper.mdl"
--SWEP.Attachments 
SWEP.Attachments = {
    [1] = {
...
--[[    [3] = {
        ...
        SlideAmount = {
            vmin = Vector(-0, -1, 8),
            vmax = Vector(-0, -1, 10),
            wmin = Vector(2400, 50, -1050), 
            wmax = Vector(2400, 50, -1050)  -- how far this attachment can slide in both directions.
        },  
    }, --]]
    [2] = {
...
--[[    [5] = {
    ...
    [6] = {
        ...
        Bone = "dlt19_sight", -- relevant bone any attachments will be mostly referring to
        Offset = {
            vpos = Vector(0.7, -0.4, -4),
            vang = Angle(90, 0, -90),
            wpos = Vector(900, 230, -370),
            wang = Angle(-10 , 0, 180)
        },
    },          
    [7] = {
