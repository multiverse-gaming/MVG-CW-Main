...
SWEP.DefaultElements = {"z6", "muzzle"}
...
SWEP.Jamming = true
SWEP.HeatGain = 0.005 -- heat gained per shot
SWEP.HeatCapacity = 5000000 -- rounds that can be fired non-stop before the gun jams, playing the "fix" animation
SWEP.HeatDissipation = 0 -- rounds' worth of heat lost per second
